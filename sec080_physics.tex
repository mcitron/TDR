...
Corresponding figures for the $Tbbbb$ models are presented in Figs.~\ref{fig:Tbbb_Yields1}-~\ref{fig:Tbbb_Yields2}.
...
\begin{figure}[]
  ...
  \caption{\label{fig:Tbbb_Yields2} Yields at $4\fbinv$ for the $Tbbbb$ in the
  hadronic signal region, for $\njet=4,5$. The binning corresponds to the analysis  bins. }
\end{figure}
