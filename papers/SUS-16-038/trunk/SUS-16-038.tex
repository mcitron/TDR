...
\begin{figure}[!t]
  ...
  \begin{center}
    \caption{(Top panel) Event yields observed in data (solid circles)
      ...
      independently.}
    \includegraphics[width=0.48\textwidth]{figures/monojet_no-fit.pdf}~ 
    \includegraphics[width=0.48\textwidth]{figures/di-jet_no-fit.pdf}\\
    \includegraphics[width=0.48\textwidth]{figures/3jet_no-fit.pdf}~
    \includegraphics[width=0.48\textwidth]{figures/4jet_no-fit.pdf}\\
    \includegraphics[width=0.48\textwidth]{figures/5jet_no-fit.pdf}~
    \includegraphics[width=0.48\textwidth]{figures/6+_jets_no-fit.pdf}\\
    \label{fig:mono}
  \end{center}
\end{figure}
