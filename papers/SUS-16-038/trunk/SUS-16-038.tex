...
\abstract{A search for supersymmetry (SUSY) is performed in final
  ...
  agree with the expected event counts from standard model processes.
  The result is interpreted with simplified models of SUSY that assume
  the production of gluino or squark pairs and their prompt decay to
  quarks and the neutralino.  The masses of bottom, top, and
  mass-degenerate light-flavour squarks are probed up to 1050, 1000,
  and 1325\GeV, respectively. The gluino mass is probed up to 1900,
  1650, and 1650\GeV when the gluino decays via virtual states of the
  aforementioned squarks. The strongest mass bounds on the daughter
  neutralinos from gluino and squark decays are 1150 and 575\GeV,
  ...
  of long-lived gluinos.  Proper decay lengths from 0.001 to
  100\,000\unit{mm} are considered, as well as a metastable gluino
  scenario. Masses up to 1750 and 900\GeV are probed for a proper
...
Collaboration. The data set analysed in this analysis is a factor of
16 larger than that presented in Ref.~\cite{Khachatryan:2016dvc}. The
...
multijet events via the strong interaction, a manifestation of quantum
chromodynamics (QCD). Several dedicated variables are employed to
...
specialized reconstruction techniques~\cite{Khachatryan:2010uf,
  Khachatryan:2011ts, Aad:2011yf, Aad:2012zn, Chatrchyan:2012sp,
  Aad:2013gva, Khachatryan:2015jha, Aad:2015rba, Aaboud:2016dgf,
  Khachatryan:2016sfv, Aaboud:2017iio} that target long-lived gluinos.
...
each jet contains at least two particle candidates and at least one
...
the differences in the modelling of \mht variable. To model the
...
over \nb and \scalht, and then repeated for each \scalht bin while
...
and $f_{\text{h}^{\pm}}^{\jet{1}}$ requirements, described in
...
coverage comparable to the T1qqqq prompt-decay scenario. A
...
\begin{figure}[!p]
  ...
  \caption{Observed upper limit in cross section at 95\% CL (indicated
    ...
    centre), and $100\,000\unit{mm}$ (lower right).  The black solid
    thick (thin) line indicates the observed excluded region assuming
    the nominal (${\pm}1$ standard deviation in theoretical
...
for models with $\ctau > 10\,000\unit{mm}$ or metastable gluinos.  For
all values of \ctau considered, the exclusion bounds on the gluino
