...
particles and the \PSGczDo. The lifetime of the $\PSg$ determines the
...
mass splittings between the parent SUSY particle and the \PSGczDo, and
...
pair and the \PSGczDo, according to its proper lifetime, which is a
...
this paper. The interactions of R-hadrons with the detector material
are not simulated, as this behaviour is not exploited due to the
generic nature of this search.
...
in terms of $m_\text{SUSY}$, $m_{\PSGczDo}$, and $c\tau$ (if
...
model parameters ($m_\text{SUSY}$, $m_{\PSGczDo}$, and $c\tau$ if
...
%$\sigma_\text{UL}$ as a function of the $\PSg$ or squark and \PSGczDo
...
%these models, with observed exclusions in $\PSg$ and \PSGczDo masses as
...
%excluded. Finally, top squark and \PSGczDo masses up to 1040 and 580\GeV
%are excluded. 
...
\begin{figure}[!t]
  ...
  \caption{Observed upper limit in cross section at 95\% CL (indicated
    by the colour scale) as a function of the $\PSg$ and \PSGczDo masses
