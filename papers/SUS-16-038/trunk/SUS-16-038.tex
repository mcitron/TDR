...
\begin{table}[!t]
  \topcaption{
    ...
    observed across all bins of the signal region. The two uncertainty
    ranges quoted determined from closure tests in data correspond to
  ...
  \begin{tabular}{ lcc }
    ...
    NLO QCD corrections                 & X--Y               & X--Y               \\
    NLO electroweak corrections         & X--Y               & X--Y               \\
    ISR (\ttbar)                        & 0.8--1.1           & --                 \\
