...
\abstract{A search for supersymmetry (SUSY) is performed in final
  ...
  agree with the expected background counts from standard model
  processes. The results are interpreted with simplified models of
  SUSY that assume the production of gluino or squark pairs and their
  ...
  the neutralinos from gluino and squark decays are 1150 and
  ...
  coverage that is complementary to existing techniques at the LHC.  }
...
of the parent gluino ($m_\PSg$) or bottom, top, and LF ($m_{\PSQb}$,
...
with $\ctau > 10\unit{m}$ or metastable gluinos.  For all values of
...
is greater than 10\GeV.  The search provides coverage that is
complementary to other dedicated techniques at the LHC, such as for
models with long-lived gluinos with $\ctau \lesssim 1\unit{mm}$.
