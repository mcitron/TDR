...
Section~\ref{sec:reconstruction}. Further, $f_{\text{h}^{\pm}}$ for
the highest \pt jet of the event, $\jet{1}$, is required to satisfy
$0.1 < f_{\text{h}^{\pm}}^{\jet{1}} < 0.95$ to further suppress beam
...
are included in the matrix-element calculation for \ttbar and vector
boson production, respectively. Simulated \wj and \zj events are
weighted according to the true vector boson \pt to account for the
effect of missing next-to-leading-order (NLO) QCD and EW terms in the
