...
\newcommand{\fh}[1]{\ensuremath{f_{\mathrm{h}^{\pm}}}\xspace}
\newcommand{\fhleadjet}[1]{\ensuremath{f_{\mathrm{h}^{\pm}}^{\jet{1}}}\xspace}
...
quarks, as well as {\ttbar}H events. The \PYTHIA 8.205~\cite{pythia}
