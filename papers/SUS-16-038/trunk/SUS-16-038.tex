...
The \MADGRAPH5 aMC@NLO 2.2.2~\cite{Alwall2014} event generator is used
...
to provide an estimate for the background, integrated over \mht,
...
prescriptions described in Secs.~\ref{sec:ttw} and \ref{sec:zinv}, are
also propagated to the corrected events. Finally, differences between
the three estimates per (\njet, \scalht) bin are adequately covered by
a systematic uncertainty of 100\% assumed to be uncorrelated for
different (\njet, \scalht) bins.
...
\begin{table}[h!]
  ...
  \begin{tabular}{ lccc }
    ...
    \hline
    Luminosity\T                   & Normalisation & Yes        & 2.5                    \\
...
2.5\%. Representative values of the dominant systematic uncertainties
