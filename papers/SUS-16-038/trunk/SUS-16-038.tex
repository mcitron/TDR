...
The search relies on several simulated event samples, produced with
Monte Carlo (MC) generator programs, to estimate the backgrounds from
various SM processes and contributions from signal models.
...
with up to two additional partons, are generated at leading order with
...
or squarks are determined at NLO plus next-to-leading-logarithm
...
$\alpha_\mathrm{s}$~\cite{Borschensky:2014cia}. The former cross
section value is determined as a function of $m_{\PSg}$ or $m_{\PSQ}$
