...
%    \mybox{2cm}{l}{($1 \cap {\geq}2a, 0$),} 
%    \mybox{2cm}{l}{($1 \cap {\geq}2a, {\geq}1$)}
    ($1 \cap {\geq}2a, 0$), ($1 \cap {\geq}2a, {\geq}1$)
                                                                                                                                     \\
                                      & 
    \mybox{2cm}{l}{Low \njet}
%    \mybox{2cm}{l}{($2 \cap 3, 0 \cap 1$),}
%    \mybox{2cm}{l}{($2 \cap 3, {\geq}2$)}
    ($2 \cap 3, 0 \cap 1$), ($2 \cap 3, {\geq}2$)
                                                                                                                                     \\
                                      & 
    \mybox{2cm}{l}{Medium \njet}
%    \mybox{2cm}{l}{($4 \cap 5, 0 \cap 1$),}
%    \mybox{2cm}{l}{($4 \cap 5, {\geq}2$)}
    ($4 \cap 5, 0 \cap 1$), ($4 \cap 5, {\geq}2$) 
                                                                                                                                     \\
                                      & 
    \mybox{2cm}{l}{High \njet}
%    \mybox{2cm}{l}{(${\geq}6, 0 \cap 1$),}
%    \mybox{2cm}{l}{(${\geq}6, {\geq}2$)}
...
Uncertainties in the jet energy scale, as large as $\sim$40\%, can
...
\begin{table*}[!t]
  ...
  \resizebox{\textwidth}{!}{
    \begin{tabular}{ lllcrrrrrcc }
      ...
      & (1900, 100)  & $\geq$5, 4, 3, 2         & 25.1           & 11--19 & 3--9   & 4--6   & 7--12 &  & 0.56 & 1.25 \\
      & (1300, 1100) & $\geq$5, 4, $\geq$5a, 4a & 14.6           & 11--22 & 2--11  & 3--11  & 2--5  &  & 0.44 & 1.15 \\ [0.5ex]
      \multirow{2}{*}{\texttt{T1tttt}}
      & (1700, 100)  & $\geq$5, $\geq$5a, 4, 3  & \phantom{1}6.9 & 12--24 & 2--6   & 3--15  & 2--6  &  & 0.51 & 1.31 \\
      & (950, 600)   & $\geq$5, $\geq$5a, 4, 4a & \phantom{1}0.3 & 15--30 & 5--9   & 12--26 & 2--6  &  & 0.89 & 1.51 \\ [0.5ex]
      \multirow{2}{*}{\texttt{T2bb}}
      & (800, 50)    & 2, 3, 4, $\geq$5         & 40.1           & 14--23 & 1--7   & 4--11  & 1--4  &  & 0.62 & 0.67 \\
      & (375, 300)   & $\geq$5, 4, 3a, 3        & \phantom{1}5.7 & 9--22  & 4--15  & 4--15  & 3--7  &  & 0.76 & 1.21 \\ [0.5ex]
...
For each benchmark model listed in Table~\ref{tab:benchmarks}, the
...
%\begin{figure}[!t]
%  \centering
%  \includegraphics[width=0.45\textwidth]{Figures/T1bbbbXSEC.pdf}~
%  \includegraphics[width=0.45\textwidth]{Figures/T1ttttXSEC.pdf}\\
%  \includegraphics[width=0.45\textwidth]{Figures/T2bbXSEC.pdf}~
%  \includegraphics[width=0.45\textwidth]{Figures/T2ttXSEC.pdf}\\
%  \includegraphics[width=0.45\textwidth]{Figures/T2ccXSEC.pdf}~ 
%  \includegraphics[width=0.45\textwidth]{Figures/T2qqXSEC.pdf}\\
...
%\begin{figure}[!t]
%  \centering
%  \includegraphics[width=0.49\textwidth]{Figures/T1qqqqXSEC.pdf}~
%  \includegraphics[width=0.49\textwidth]{Figures/T1qqqqXSEC.pdf}\\
%  \caption{Observed upper limit in cross section at 95\% confidence
%    level (indicated by the colour scale) for simplified models that
%    assume (Top Left) gluino-mediated and (Top Right) direct
%    production of bottom squarks or the direct production of top
%    squarks that each decay to (Bottom Left) the top quark or (Bottom
%    Right) the charm quark and the $\chiz_{1}$, as a function of the
%    gluino or squark mass and the $\chiz_{1}$ mass. The black solid
%    thick (thin) line indicates the observed mass exclusion regions
%    assuming the nominal (${\pm}1 \sigma$ theory uncertainty)
%    production cross section. The red dashed thick (thin) line
%    indicates the median (${\pm}1 \sigma$ experimental uncertainty)
%    expected mass exclusion regions.  }
%  \label{fig:t1qqqq} 
%\end{figure}
...
%\begin{figure}[!t]
%  \centering
%  \includegraphics[width=0.45\textwidth]{Figures/T1qqqqXSEC.pdf}~
%  \includegraphics[width=0.45\textwidth]{Figures/finalCanvas_SMS_T1qqqqLL_ctau_0p001_ObsLimit}\\
%  \includegraphics[width=0.45\textwidth]{Figures/finalCanvas_SMS_T1qqqqLL_ctau_0p01_ObsLimit}~
%  \includegraphics[width=0.45\textwidth]{Figures/finalCanvas_SMS_T1qqqqLL_ctau_0p1_ObsLimit}\\
%  \includegraphics[width=0.45\textwidth]{Figures/finalCanvas_SMS_T1qqqqLL_ctau_1_ObsLimit}~
%  \includegraphics[width=0.45\textwidth]{Figures/finalCanvas_SMS_T1qqqqLL_ctau_10_ObsLimit}\\
%  \caption{T1qqqq model with prompt decay (upper left) and T1qqqqLL
%    model with $c\tau = 0.001\unit{mm}$ (upper right), $0.01\unit{mm}$
%    (middle left), $0.1\unit{mm}$ (middle right), $1\unit{mm}$ (lower
%    left), and $10\unit{mm}$ (lower right).}
%  \label{fig:limits} 
%\end{figure}
%
%\clearpage
%\begin{figure}[!t]
%  \centering
%  \includegraphics[width=0.45\textwidth]{Figures/finalCanvas_SMS_T1qqqqLL_ctau_100_ObsLimit}~
%  \includegraphics[width=0.45\textwidth]{Figures/finalCanvas_SMS_T1qqqqLL_ctau_1000_ObsLimit}\\
%  \includegraphics[width=0.45\textwidth]{Figures/finalCanvas_SMS_T1qqqqLL_ctau_10000_ObsLimit}~
%  \includegraphics[width=0.45\textwidth]{Figures/finalCanvas_SMS_T1qqqqLL_ctau_100000_ObsLimit}\\
%  \caption{T1qqqqLL model with $c\tau = 100\unit{mm}$ (upper left),
%    $1\unit{m}$ (upper right), $10\unit{mm}$ (lower left), and
