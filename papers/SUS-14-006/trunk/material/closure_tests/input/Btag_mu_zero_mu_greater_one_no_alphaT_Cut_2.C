...
//=========  (Sat Jul 26 19:52:55 2014) by ROOT version5.34/09
   ...
   grae->SetPoint(1,237.5,0.05035147);
   grae->SetPointError(1,0,0,0.02438508,0.02438508);
   grae->SetPoint(2,300,0.01927777);
   grae->SetPointError(2,0,0,0.03237669,0.03237669);
   grae->SetPoint(3,350,0.02904025);
   grae->SetPointError(3,0,0,0.04167817,0.04167817);
   grae->SetPoint(4,425,-0.05555678);
   grae->SetPointError(4,0,0,0.04349831,0.04349831);
   grae->SetPoint(5,525,-0.07309943);
   grae->SetPointError(5,0,0,0.07413401,0.07413401);
   grae->SetPoint(6,625,-0.2594039);
   grae->SetPointError(6,0,0,0.1217797,0.1217797);
   grae->SetPoint(7,725,-0.05809373);
   grae->SetPointError(7,0,0,0.2126654,0.2126654);
   grae->SetPoint(8,825,0.03784196);
   grae->SetPointError(8,0,0,0.3079379,0.3079379);
   grae->SetPoint(9,925,-0.238535);
   grae->SetPointError(9,0,0,0.4672802,0.4672802);
   grae->SetPoint(10,1025,-0.6194221);
   grae->SetPointError(10,0,0,0.7521118,0.7521118);
   grae->SetPoint(11,1125,-0.4906439);
   grae->SetPointError(11,0,0,0.5835204,0.5835204);
   ...
   fit->SetParameter(0,0.01367245);
   fit->SetParError(0,0.01575007);
   ...
   TText *text = ptstats->AddText("#chi^{2} / ndf = 13.23 / 10");
   text = ptstats->AddText("p0       = 0.01367 #pm 0.01575 ");
