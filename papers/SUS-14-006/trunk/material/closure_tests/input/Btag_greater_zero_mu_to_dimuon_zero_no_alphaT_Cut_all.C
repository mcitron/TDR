...
//=========  (Sat Jul 26 19:55:25 2014) by ROOT version5.34/09
   ...
   grae->SetPoint(1,237.5,-0.04779987);
   grae->SetPointError(1,0,0,0.02609142,0.02609142);
   grae->SetPoint(2,300,0.0546497);
   grae->SetPointError(2,0,0,0.03265596,0.03265596);
   grae->SetPoint(3,350,0.02599787);
   grae->SetPointError(3,0,0,0.04247642,0.04247642);
   grae->SetPoint(4,425,0.07102754);
   grae->SetPointError(4,0,0,0.0425937,0.0425937);
   grae->SetPoint(5,525,-0.02146784);
   grae->SetPointError(5,0,0,0.06001923,0.06001923);
   grae->SetPoint(6,625,0.1521375);
   grae->SetPointError(6,0,0,0.0937642,0.0937642);
   grae->SetPoint(7,725,-0.002803354);
   grae->SetPointError(7,0,0,0.1277847,0.1277847);
   grae->SetPoint(8,825,0.01467518);
   grae->SetPointError(8,0,0,0.1828512,0.1828512);
   grae->SetPoint(9,925,0.145058);
   grae->SetPointError(9,0,0,0.2648209,0.2648209);
   grae->SetPoint(10,1025,0.1640066);
   grae->SetPointError(10,0,0,0.3641049,0.3641049);
   grae->SetPoint(11,1125,-0.08093818);
   grae->SetPointError(11,0,0,0.3100834,0.3100834);
   ...
   fit->SetParameter(0,0.01208572);
   fit->SetParError(0,0.01575866);
   ...
   TText *text = ptstats->AddText("#chi^{2} / ndf = 12.06 / 10");
   text = ptstats->AddText("p0       = 0.01209 #pm 0.01576 ");
