...
//=========  (Sat Jul 26 19:52:55 2014) by ROOT version5.34/09
   ...
   grae->SetPoint(4,425,0.02292171);
   grae->SetPointError(4,0,0,0.04026777,0.04026777);
   grae->SetPoint(5,525,-0.06820111);
   grae->SetPointError(5,0,0,0.06318504,0.06318504);
   grae->SetPoint(6,625,0.009243008);
   grae->SetPointError(6,0,0,0.09884255,0.09884255);
   grae->SetPoint(7,725,0.03788862);
   grae->SetPointError(7,0,0,0.1549099,0.1549099);
   grae->SetPoint(8,825,0.2305344);
   grae->SetPointError(8,0,0,0.2532457,0.2532457);
   grae->SetPoint(9,925,-0.05162358);
   grae->SetPointError(9,0,0,0.317542,0.317542);
   grae->SetPoint(10,1025,0.3622235);
   grae->SetPointError(10,0,0,0.5315101,0.5315101);
   grae->SetPoint(11,1125,-0.1364608);
   grae->SetPointError(11,0,0,0.4575087,0.4575087);
   ...
   fit->SetParameter(0,0.003149199);
   fit->SetParError(0,0.03093368);
   ...
   TText *text = ptstats->AddText("#chi^{2} / ndf = 2.956 / 7");
   text = ptstats->AddText("p0       = 0.003149 #pm 0.03093 ");
