...
//=========  (Sat Jul 26 19:54:10 2014) by ROOT version5.34/09
   ...
   grae->SetPoint(4,425,0.003976813);
   grae->SetPointError(4,0,0,0.2222344,0.2222344);
   grae->SetPoint(5,525,-0.2558418);
   grae->SetPointError(5,0,0,0.2481024,0.2481024);
   grae->SetPoint(6,625,0.09289821);
   grae->SetPointError(6,0,0,0.3427813,0.3427813);
   grae->SetPoint(7,725,-0.4501855);
   grae->SetPointError(7,0,0,0.5643924,0.5643924);
   grae->SetPoint(8,825,0.4520974);
   grae->SetPointError(8,0,0,0.6703785,0.6703785);
   grae->SetPoint(9,925,-0.4387728);
   grae->SetPointError(9,0,0,0.7721721,0.7721721);
   grae->SetPoint(10,1025,-1);
   grae->SetPointError(10,0,0,1.589843,1.589843);
   grae->SetPoint(11,1125,-0.3185162);
   grae->SetPointError(11,0,0,0.7611664,0.7611664);
   ...
   fit->SetParameter(0,-0.09920624);
   fit->SetParError(0,0.1358723);
   ...
   TText *text = ptstats->AddText("#chi^{2} / ndf = 2.589 / 7");
   text = ptstats->AddText("p0       = -0.09921 #pm 0.1359 ");
