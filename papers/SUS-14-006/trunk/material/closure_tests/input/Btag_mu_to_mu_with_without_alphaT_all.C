...
//=========  (Sat Jul 26 19:55:25 2014) by ROOT version5.34/09
   ...
   grae->SetPoint(1,237.5,0.002237542);
   grae->SetPointError(1,0,0,0.01764506,0.01764506);
   grae->SetPoint(2,300,0.008207228);
   grae->SetPointError(2,0,0,0.02098448,0.02098448);
   grae->SetPoint(3,350,-0.05490964);
   grae->SetPointError(3,0,0,0.02659215,0.02659215);
   grae->SetPoint(4,425,-0.07417782);
   grae->SetPointError(4,0,0,0.02880741,0.02880741);
   grae->SetPoint(5,525,-0.09406151);
   grae->SetPointError(5,0,0,0.04317165,0.04317165);
   grae->SetPoint(6,625,-0.1091225);
   grae->SetPointError(6,0,0,0.06743499,0.06743499);
   grae->SetPoint(7,725,0.1558966);
   grae->SetPointError(7,0,0,0.1131694,0.1131694);
   grae->SetPoint(8,825,-0.1472248);
   grae->SetPointError(8,0,0,0.1784653,0.1784653);
   grae->SetPoint(9,925,-0.09723885);
   grae->SetPointError(9,0,0,0.2788164,0.2788164);
   grae->SetPoint(10,1025,-0.201085);
   grae->SetPointError(10,0,0,0.4272687,0.4272687);
   grae->SetPoint(11,1125,-0.5893713);
   grae->SetPointError(11,0,0,0.449056,0.449056);
   ...
   fit->SetParameter(0,-0.02373443);
   fit->SetParError(0,0.01054611);
   ...
   TText *text = ptstats->AddText("#chi^{2} / ndf = 18.01 / 10");
   text = ptstats->AddText("p0       = -0.02373 #pm 0.01055 ");
