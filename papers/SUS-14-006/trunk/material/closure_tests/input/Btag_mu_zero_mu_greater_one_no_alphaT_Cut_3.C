...
//=========  (Sat Jul 26 19:54:10 2014) by ROOT version5.34/09
   ...
   grae->SetPoint(1,237.5,0.04683857);
   grae->SetPointError(1,0,0,0.07380617,0.07380617);
   grae->SetPoint(2,300,0.02713528);
   grae->SetPointError(2,0,0,0.03937963,0.03937963);
   grae->SetPoint(3,350,0.007178031);
   grae->SetPointError(3,0,0,0.05326306,0.05326306);
   grae->SetPoint(4,425,0.01829706);
   grae->SetPointError(4,0,0,0.05197402,0.05197402);
   grae->SetPoint(5,525,0.1186109);
   grae->SetPointError(5,0,0,0.06313374,0.06313374);
   grae->SetPoint(6,625,-0.08118012);
   grae->SetPointError(6,0,0,0.07769233,0.07769233);
   grae->SetPoint(7,725,0.004852443);
   grae->SetPointError(7,0,0,0.1180704,0.1180704);
   grae->SetPoint(8,825,-0.1764633);
   grae->SetPointError(8,0,0,0.1631008,0.1631008);
   grae->SetPoint(9,925,-0.2909098);
   grae->SetPointError(9,0,0,0.2143314,0.2143314);
   grae->SetPoint(10,1025,-0.4794022);
   grae->SetPointError(10,0,0,0.3398919,0.3398919);
   grae->SetPoint(11,1125,-0.3053235);
   grae->SetPointError(11,0,0,0.2774728,0.2774728);
   ...
   fit->SetParameter(0,0.01460828);
   fit->SetParError(0,0.02171657);
   ...
   TText *text = ptstats->AddText("#chi^{2} / ndf =  11.4 / 10");
   text = ptstats->AddText("p0       = 0.01461 #pm 0.02172 ");
