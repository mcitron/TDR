...
\tiny
\centering
\caption{Pre fit Predictions and Data in the signal region for 2.1\fbinv for monojet categories. All entries are non-zero but are truncated to one decimal place.\label{tab:predewkdata_sig_comb_mono}}
