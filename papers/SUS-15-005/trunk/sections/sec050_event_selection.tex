...
%The \bdphi variable provides comparable or improved performance in
%terms of discrimination according to a simple signal-to-background
%metric for a wide range of signal models with respect to more widely
...
requirement is $\scalht > 800\GeV$. For both distributions, events
must satisfy the requirement $\njet \geq 2$ and are recorded with a
set of inclusive trigger conditions that are independent of the
...
values of $\sim 90\%$ and $\sim 99\%$, respectively.
