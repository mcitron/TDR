...
%    common preselection and full signal region selection criteria, the
%    additional requirement $\scalht > 300\GeV$, and, respectively,
%    $\alphat < 0.55$ and $\alphat > 0.55$.  
    (Left) The \alphat distribution observed in data for events
