...
of the detector in the directions, respectively, along and
...
corresponding ECAL and HCAL energy, corrected for the response
function of the calorimeters to hadronic showers. Neutral hadrons are
identified as HCAL energy clusters not linked to any charged hadron
trajectory, or as ECAL and HCAL energy excesses with respect to the
expected charged hadron energy deposit.  The energy of neutral hadrons
...
employed that yields a b-tagging efficiency, and charm and
light-flavour mistag probabilities of, respectively, approximately
65\%, 12\%, and 1\% for jets with transverse momenta typical of \ttbar
events.
