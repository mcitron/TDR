...
observations in the signal region as well as the control regions. The
data are well described by the background-only hypothesis. A saturated
likelihood model %~\cite{}
...
hypothesis. A $p$-value of 0.20 is observed for the fit over the full
