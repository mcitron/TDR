...
is supported by astrophysical data. %~\cite{}.
...
In this search, to ensure sensitivity to the broadest possible region
...
%is particularly sensitive to the uncertainties in the estimation of a
...
The search is built around the kinematical variable
