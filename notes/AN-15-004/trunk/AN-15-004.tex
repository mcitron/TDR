...
%%____________________________________________________________________________||
\abstract{This note summarises an inclusive search
...
momenta of these jets. We analyse 0.53~$\text{fb}^{-1}$ of data and also present 
projections for sensitivity to various benchmark simplified
