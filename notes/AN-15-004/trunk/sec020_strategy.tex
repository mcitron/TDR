...
favours of squarks. The large dynamic range in \scalht provides
...
would correspond to a threshold of $\sim0.507$). While the use of
...
two samples will closely mirror their \mj and \mjj
counterparts. 

Further, as a baseline, we plan to mirror the \scalht-dependent
\alphat thresholds of the signal region in the \gj
