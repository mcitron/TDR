...
We added the e + jets and ee + jets data control samples. These two
...
help reduce the statistical uncertainties associated with the
...
allow many additional closure tests to be performed, which
further improves the understanding of the transfer factors constructed
