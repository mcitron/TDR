...
<<<<<<< Updated upstream:notes/AN-15-004/trunk/sec110_likelihood.tex
...
as they are defined in \ref{}, namely: $e$ + jets, $ee$ + jets, $\mu$ + jets, $\mu\mu$ + jets and $\gamma$ + jets. \\ %FIXME: add reference to relevant section
...
by means of transfer factors, as explained in \ref{}. %FIXME: add reference
...
Other systematic uncertainties are incorporated in the likelihood through nuisance parameters, 
