...
\tiny
\centering
\caption{Yields and Data in the \mmj region for 2.1\ifb for monojet categories. All entries are non-zero but are truncated to one decimal place.\label{tab:yieldsall_mumu_comb_mono}}
\begin{tabular}
{cccccccccc}
	\hline\hline
