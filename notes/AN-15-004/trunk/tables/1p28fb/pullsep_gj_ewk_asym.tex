...
\tiny
\centering
\topcaption{Pull in the \gj control region for 1.26\ifb for asymmetric and monojet categories. The letter ``a'' in jet \eg ``2a''  indicates the asymmetric jet bins.\label{tab:pullsep_ewk_gj_asym}}
\begin{tabular}
{ccccc}
	\hline\hline
