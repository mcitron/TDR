...
\tiny
\centering
\topcaption{Yields in the \mmj control region for 1.26\ifb for asymmetric and monojet categories. The letter ``a'' in jet \eg ``2a''  indicates the asymmetric jet bins.\label{tab:yieldssep_data_mumu_asym}}
\begin{tabular}
{ccccccccc}
	\hline\hline
