...
\tiny
\centering
\topcaption{Predictions for the Data process in the signal region for 1.26\ifb for symmetric categories. The letter ``a'' in jet \eg ``2a''  indicates the asymmetric jet bins.\label{tab:predsep_data_sig_sym}}
\begin{tabular}
{ccccccccc}
	\hline\hline
