...
\tiny
\centering
\caption{Predictions and Data in the \mmj region for 1.26\ifb for asymmetric and monojet categories. The letter ``a'' in jet \eg ``2a''  indicates the asymmetric jet bins. All entries are non-zero but are truncated to one decimal place.\label{tab:yieldsseppost_mumu_data_asym}}
\begin{tabular}
{ccccccccc}
	\hline\hline
