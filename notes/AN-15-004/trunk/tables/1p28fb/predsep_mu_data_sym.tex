...
\tiny
\centering
\topcaption{Predictions in the \mj control region for 1.26\ifb for symmetric categories. The letter ``a'' in jet \eg ``2a''  indicates the asymmetric jet bins.\label{tab:predsep_data_mu_sym}}
\begin{tabular}
{ccccccccc}
	\hline\hline
