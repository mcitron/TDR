...
\tiny
\centering
\caption{Yields and Data in the \mj region for 1.26\ifb for monojet categories. The letter ``a'' in jet \eg ``2a''  indicates the asymmetric jet bins. All entries are non-zero but are truncated to one decimal place.\label{tab:yieldsall_mu_comb_mono}}
\begin{tabular}
{cccccccccc}
	\hline\hline
