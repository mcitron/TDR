...
\begin{figure}[!h]
  ...
  \subfigure[QCD events in signal region.\label{fig:qcd_pass}]{
    \includegraphics[width=0.5\textwidth]{figures/qcd/v2/QCD/SigTrig_PassMoM_NJet_vs_HT_bDPhigt0p5_Log}
  } 
  \subfigure[QCD events in \mhtmet sideband.\label{fig:qcd_fail}]{
    \includegraphics[width=0.5\textwidth]{figures/qcd/v2/QCD/SigTrig_FailMoM_NJet_vs_HT_bDPhigt0p5_Log}
  } \\
  \subfigure[Ratio \rmhtmet for QCD events.\label{fig:qcd_ratio}]{
    \includegraphics[width=0.5\textwidth]{figures/qcd/v2/QCD/SigTrig_RMoM_NJet_vs_HT_bDPhigt0p5_Log}
  } 
  \subfigure[EWK events in \mhtmet sideband.\label{fig:ewk_fail}]{
    \includegraphics[width=0.5\textwidth]{figures/qcd/v2/Ewk/SigTrig_FailMoM_NJet_vs_HT_bDPhigt0p5_Log}
  } \\
...
\begin{figure}[!h]
  ...
  \subfigure[Binned data counts in \mhtmet sideband.\label{fig:data_fail}]{
    \includegraphics[width=0.5\textwidth]{figures/qcd/v2/SigTrig_FailMoM_NJet_vs_HT_bDPhigt0p5_Log}
  } 
  \subfigure[Corrected data counts in \mhtmet sideband.\label{fig:data_corr}]{
    \includegraphics[width=0.5\textwidth]{figures/qcd/v2/DataNoEwk_SigTrig_FailMoM_NJet_vs_HT_bDPhigt0p5_Log}
  } \\
