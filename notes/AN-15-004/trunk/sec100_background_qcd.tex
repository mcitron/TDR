...
In Fig.~\ref{fig:bDPhi_mhtJetPhi} a comparison of the abilities of the \bdphi variable to 
...
\begin{figure}[!h]
  ...
  \caption{\bDPhi and \dphimhtj distributions of QCD multijet simulation after analysis selections
    for \ht $> 800$ \GeV in the case of nominal reconstruction (a), (b) and severe mismeasurement (c), (d).
    The total number of events that pass a $\Delta\phi > 0.5$ selection of the respective quantity 
    are indicated.
}
