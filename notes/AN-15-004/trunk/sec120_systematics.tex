...
\begin{figure}[h!]
  \begin{center}
    \subfigure[$\njet =
    2$]{\includegraphics[width=0.5\textwidth]{figures/closureTests/552pb/mht130/eq2j.pdf}} ~~
    \subfigure[$\njet = 3$]{\includegraphics[width=0.5\textwidth]{figures/closureTests/552pb/mht130/eq3j.pdf}} \\
    \subfigure[$\njet = 4$]{\includegraphics[width=0.5\textwidth]{figures/closureTests/552pb/mht130/eq4j.pdf}} ~~
    \subfigure[$\njet \geq 5$]{\includegraphics[width=0.5\textwidth]{figures/closureTests/552pb/mht130/ge5j.pdf}} \\
    \caption{Sets of closure tests (open symbols) overlaid on top of
      the systematic uncertainty estimates used for each of the seven
...
\begin{figure}[h!]
  \begin{center}
    \subfigure[$\njet = 2$]{\includegraphics[width=0.5\textwidth]{figures/closureTests/552pb/mht130/eq2a.pdf}} ~~
    \subfigure[$\njet = 3$]{\includegraphics[width=0.5\textwidth]{figures/closureTests/552pb/mht130/eq3a.pdf}} \\
    \subfigure[$\njet = 4$]{\includegraphics[width=0.5\textwidth]{figures/closureTests/552pb/mht130/eq4a.pdf}} ~~
    \subfigure[$\njet \geq 5$]{\includegraphics[width=0.5\textwidth]{figures/closureTests/552pb/mht130/ge5a.pdf}} \\
    \caption{Sets of closure tests (open symbols) overlaid on top of
      the systematic uncertainty estimates used for each of the seven
      \scalht bins (shaded bands) carried out with $552\ipb$ of
...
\begin{figure}[h!]
  \begin{center}
    \subfigure[$\njet = 1$]{\includegraphics[width=0.7\textwidth]{figures/closureTests/552pb/mht130/eq1j.pdf}} 
    \caption{Sets of closure tests (open symbols) overlaid on top of
      the systematic uncertainty estimates used for each of the seven
      \scalht bins (shaded bands) carried out with $552\ipb$ of
...
\begin{figure}[]
  ...
  \subfigure[Expected systematic uncertainties]{
    \includegraphics[width=0.5\textwidth]{figures/closureTests/552pb/mht130/exp2D.pdf}
  } ~~
  \subfigure[Observed divided by expected systematic uncertainties]{
    \includegraphics[width=0.5\textwidth]{figures/closureTests/552pb/mht130/obsDivExp.pdf}
  }
...
\subsection{MC based studies of additional potential sources of
systematic uncertainty}
\label{sec:closure-tests-desc}

%%%%%%%%%%%%%%%%%%%%%%%% SECTION FOR CHRISTIAN %%%%%%%%%%%%%%%%%%%%
