...
Fig.~\ref{fig:ZinvclosureDataSym}.
...
categories. In Figs.~\ref{fig:ttWclosureDataSym}~and~\ref{fig:ZinvclosureDataSym} are the results of the
closure tests performed on events in the ``symmetric'' jet category
and in
Figs.~\ref{fig:ttWclosureDataAsym}~and~\ref{fig:ZinvclosureDataAsym} the results of the closure tests
...
\begin{figure}[h!]
  \begin{center}
    \subfigure[$\njet =
    2$]{\includegraphics[width=0.5\textwidth]{figures/closureTests/newJamboree/summaryPlots/zinv_lt400_eq2j}} ~~
    \subfigure[$\njet =
    3$]{\includegraphics[width=0.5\textwidth]{figures/closureTests/newJamboree/summaryPlots/zinv_lt400_eq3j}} \\
    \subfigure[$\njet =
    4$]{\includegraphics[width=0.5\textwidth]{figures/closureTests/newJamboree/summaryPlots/zinv_lt400_eq4j}} ~~
    \subfigure[$\njet \geq
    5$]{\includegraphics[width=0.5\textwidth]{figures/closureTests/newJamboree/summaryPlots/zinv_lt400_ge5j}} \\
    \caption{Sets of closure tests (open symbols) designed to probe
...
\begin{figure}[h!]
  \begin{center}
    \subfigure[$\njet =
    2$]{\includegraphics[width=0.5\textwidth]{figures/closureTests/newJamboree/summaryPlots/zinv_gt400_eq2j}} ~~
    \subfigure[$\njet =
    3$]{\includegraphics[width=0.5\textwidth]{figures/closureTests/newJamboree/summaryPlots/zinv_gt400_eq3j}} \\
    \subfigure[$\njet =
    4$]{\includegraphics[width=0.5\textwidth]{figures/closureTests/newJamboree/summaryPlots/zinv_gt400_eq4j}} ~~
    \subfigure[$\njet \geq
    5$]{\includegraphics[width=0.5\textwidth]{figures/closureTests/newJamboree/summaryPlots/zinv_gt400_ge5j}} \\
    \caption{Sets of closure tests (open symbols) designed to probe
      the \znunu + jets background, overlaid on top of
      the systematic uncertainty estimates for each of the seven
      \scalht bins (shaded bands) carried out with $1.28\ifb$ of
...
\begin{figure}[h!]
  \begin{center}
    \subfigure[$\njet =
    2$]{\includegraphics[width=0.5\textwidth]{figures/closureTests/newJamboree/summaryPlots/zinv_lt400_eq2a}} ~~
    \subfigure[$\njet =
    3$]{\includegraphics[width=0.5\textwidth]{figures/closureTests/newJamboree/summaryPlots/zinv_lt400_eq3a}} \\
    \subfigure[$\njet =
    4$]{\includegraphics[width=0.5\textwidth]{figures/closureTests/newJamboree/summaryPlots/zinv_lt400_eq4a}} ~~
    \subfigure[$\njet \geq
    5$]{\includegraphics[width=0.5\textwidth]{figures/closureTests/newJamboree/summaryPlots/zinv_lt400_ge5a}} \\
    \caption{Sets of closure tests (open symbols) designed to probe
      the \znunu + jets background, overlaid on top of
      the systematic uncertainty estimates for each of the seven
      \scalht bins (shaded bands) carried out with $1.28\ifb$ of
...
\begin{figure}[h!]
  \begin{center}
    \subfigure[$\njet =
    2$]{\includegraphics[width=0.5\textwidth]{figures/closureTests/newJamboree/summaryPlots/zinv_gt400_eq2a}} ~~
    \subfigure[$\njet =
    3$]{\includegraphics[width=0.5\textwidth]{figures/closureTests/newJamboree/summaryPlots/zinv_gt400_eq3a}} \\
    \subfigure[$\njet =
    4$]{\includegraphics[width=0.5\textwidth]{figures/closureTests/newJamboree/summaryPlots/zinv_gt400_eq4a}} ~~
    \subfigure[$\njet \geq
    5$]{\includegraphics[width=0.5\textwidth]{figures/closureTests/newJamboree/summaryPlots/zinv_gt400_ge5a}} \\
    \caption{Sets of closure tests (open symbols) designed to probe
      the \znunu + jets background, overlaid on top of
      the systematic uncertainty estimates for each of the seven
      \scalht bins (shaded bands) carried out with $1.28\ifb$ of
...
Fig.~\ref{tab:systs}. In the kinematically restricted bins, such
...
\begin{figure}[h!]
  \begin{center}
    \subfigure[]{\includegraphics[width=0.5\textwidth]{figures/closureTests/newJamboree/alphaTOnlyTest.pdf}}
    ~~
    \subfigure[]{\includegraphics[width=0.5\textwidth]{figures/closureTests/newJamboree/alphaTPulls.pdf}} 
...
\begin{figure}[h!]
  \begin{center}
    \subfigure[Closure
    tests]{\includegraphics[width=0.5\textwidth]{figures/closureTests/newJamboree/bDPhiCrossCheck.pdf}}
    ~~
    \subfigure[Pulls of closure
    tests]{\includegraphics[width=0.5\textwidth]{figures/closureTests/newJamboree/bDPhiPulls.pdf}} 
...
\begin{figure}[h!]
  \begin{center}
    \subfigure[Closure tests]{\includegraphics[width=0.5\textwidth]{figures/closureTests/newJamboree/looseLeptonCrossCheck.pdf}}
    ~~
    \subfigure[Pulls of closure
    tests]{\includegraphics[width=0.5\textwidth]{figures/closureTests/newJamboree/looseLeptonPulls.pdf}} 
