...
A summary of the all the uncertainties is given in table \ref{tab:systs}.
...
as well as the simulation of the kinematics of the processes (top $p_{T}$). 
These corrections are described in Sec. ~\ref{}. \\
...
for the background prediction, namely: $\mj \rightarrow \znunu$, $\mmj \rightarrow \znunu$, $\gj \rightarrow \znunu$ and $\mj \rightarrow \mathrm{tt+W}$. 
...
%FIXME: add representative numbers
...
\begin{figure}[]
  ...
  \caption{\label{fig:tfSyst_jec_muToZinv} The relative change in the $\mj \rightarrow \znunu$ transfer
...
\begin{figure}[]
  ...
  \caption{\label{fig:tfSyst_jec_mumuToZinv} The relative change in the $\mmj \rightarrow \znunu$ transfer
  factors when varying JEC in MC within its uncertainties, as a function of \scalht and jet category. 
  Variations corresponding to $+1\sigma$ ($-1\sigma$) are shown in the left (right) figure. 
  }
\end{figure}
...
\begin{figure}[]
  ...
  \caption{\label{fig:tfSyst_jec_gjToZinv} The relative change in the $\gj \rightarrow \znunu$ transfer
  factors when varying JEC in MC within its uncertainties, as a function of \scalht and jet category. 
  Variations corresponding to $+1\sigma$ ($-1\sigma$) are shown in the left (right) figure. 
  }
\end{figure}
...
\begin{figure}[]
  ...
  \caption{\label{fig:tfSyst_jec_muToTtw} The relative change in the $\mj \rightarrow \mathrm{tt+W}$ transfer
  factors when varying JEC in MC within its uncertainties, as a function of \scalht and jet category. 
  Variations corresponding to $+1\sigma$ ($-1\sigma$) are shown in the left (right) figure. 
  }
\end{figure}
...
\begin{figure}[]
  ...
  \caption{\label{fig:tfSyst_bsf_muToZinv} The relative change in the $\mj \rightarrow \znunu$ transfer
...
\begin{figure}[]
  ...
  \caption{\label{fig:tfSyst_bsf_mumuToZinv} The relative change in the $\mmj \rightarrow \znunu$ transfer
  factors when varying b-tag SF in MC within its uncertainties, as a function of \scalht and jet category. 
  Variations corresponding to $+1\sigma$ ($-1\sigma$) are shown in the left (right) figure. 
  }
\end{figure}
...
\begin{figure}[]
  ...
  \caption{\label{fig:tfSyst_bsf_gjToZinv} The relative change in the $\gj \rightarrow \znunu$ transfer
  factors when varying b-tag SF in MC within its uncertainties, as a function of \scalht and jet category. 
  Variations corresponding to $+1\sigma$ ($-1\sigma$) are shown in the left (right) figure. 
  }
\end{figure}
...
is presented in Fig. ~\ref{fig:tfSyst_topPt_muToZinv}-\ref{fig:tfSyst_topPt_muToTtw}.
...
The relative change in transfer factors is presented in Fig. ~\ref{fig:tfSyst_topPt_muToZinv}-\ref{fig:tfSyst_topPt_muToTtw}.
...
using the photon control region, described in Sec. ~\ref{}.
...
of primary vertex multiplicity observed in data, as described in Sec. ~\ref{sec:pileup-reweighting}.
...
The relative change in the transfer factors under this variation is small (~1\%)
...
\begin{figure}[h!]
  \begin{center}
    \subfigure[]{\includegraphics[width=0.5\textwidth]{figures/closureTests/alphaTsym__fit.pdf}}
    ~~
    \subfigure[]{\includegraphics[width=0.5\textwidth]{figures/closureTests/alphaTasym__fit.pdf}}\\
    \subfigure[]{\includegraphics[width=0.5\textwidth]{figures/closureTests/bDPhisym__fit.pdf}}
    ~~
    \subfigure[]{\includegraphics[width=0.5\textwidth]{figures/closureTests/bDPhiasym__fit.pdf}} 
...
\begin{figure}[h!]
  \begin{center}
    \subfigure[]{\includegraphics[width=0.5\textwidth]{figures/closureTests/mu_mumusym_half_fit.pdf}}
    ~~
    \subfigure[]{\includegraphics[width=0.5\textwidth]{figures/closureTests/mu_mumuasym_half_fit.pdf}} 
...
\begin{figure}[h!]
  \begin{center}
    \subfigure[]{\includegraphics[width=0.5\textwidth]{figures/closureTests/muplus_muminussym__fit.pdf}}
    ~~
    \subfigure[]{\includegraphics[width=0.5\textwidth]{figures/closureTests/muplus_muminusasym__fit.pdf}} 
...
\begin{figure}[h!]
  \begin{center}
    \subfigure[]{\includegraphics[width=0.5\textwidth]{figures/closureTests/phot_mumusym_half_fit.pdf}}
    ~~
    \subfigure[]{\includegraphics[width=0.5\textwidth]{figures/closureTests/phot_mumuasym_half_fit.pdf}} 
...
by the dedicated study presented in Sec. ~\ref{}.
...
\begin{figure}[h!]
  \begin{center}
    \subfigure[]{\includegraphics[width=0.5\textwidth]{figures/closureTests/eq0b_eq1b_muonsym__fit.pdf}}
    ~~
    \subfigure[]{\includegraphics[width=0.5\textwidth]{figures/closureTests/eq0b_eq1b_muonasym__fit.pdf}} 
...
\begin{table}[h!]
  ...
  \begin{tabular}{ ccccccc }
    ...
    Jet energy scale & MC variations & $<0.1$ & $<0.1$ & $<0.1$ & $<0.1$ & fully correlated \\
    B-tagging efficiency & MC variations & $<0.05$ & $<0.02$ & $<0.02$ & $0.02-0.03$ & fully correlated \\
    Pileup weights & MC variations & $0.01-0.02$  & $0.01-0.02$ & $0.01-0.02$ & $0.01-0.02$ & fully correlated \\
    Top $p_{T}$ weights & MC variations & $<0.15$  & $<0.05$ & - & $<0.1$ & fully correlated \\
    Lepton selection & MC variations & - & - & - & $0.01-0.03$ & fully correlated \\
    \hline
    \hline
  \end{tabular}
\end{table}
