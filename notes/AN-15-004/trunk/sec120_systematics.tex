...
\begin{figure}[h!]
  \begin{center}
    \subfigure[Closure tests]{\includegraphics[width=0.7\textwidth]{figures/closureTests/newJamboree/looseLeptonCrossCheck.pdf}}
    ~~
    \subfigure[Pulls of closure
    tests]{\includegraphics[width=0.7\textwidth]{figures/closureTests/newJamboree/looseLeptonPulls.pdf}} 
