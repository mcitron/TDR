...
The aformentioned two b-tag related tests also probe the modelling of
...
taken as an additional contriubtion to the total normalisation
...
The $\njet=2\rightarrow\njet=3$ and $\njet=4\rightarrow\njet\geq5$
tests are an agressive test of the simulation modelling of jet
...
control regions. Applying an aribtrarily large variation of $\pm
