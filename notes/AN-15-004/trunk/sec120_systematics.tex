...
\begin{figure}[h!]
  \begin{center}
    \subfigure[]{\includegraphics[width=0.45\textwidth]{figures/closureTests/muplus_muminussym_half_fit.pdf}}
    ~~
    \subfigure[]{\includegraphics[width=0.45\textwidth]{figures/closureTests/muplus_muminusasym_half_fit.pdf}} 
...
\begin{figure}[h!]
  \begin{center}
    \subfigure[]{\includegraphics[width=0.45\textwidth]{figures/closureTests/eq0b_eq1b_muonsym_fit.pdf}}
    ~~
    \subfigure[]{\includegraphics[width=0.45\textwidth]{figures/closureTests/eq0b_eq1b_muonasym_fit.pdf}} 
