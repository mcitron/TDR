...
of these systematics are determined using the method described in Sec~\ref{sec:bkgdnorm-syst}.
The uncertainties on the signal efficiency times acceptance, described in Sec.~\ref{subsec:susy_results}, 
