...
Tables showing the yields for these electroweak backgrounds can be
seen in Table~\ref{tab:yields_ewk_sig}.  An overview of the three
dominant channels, \ttbar, \zInv~ and W~+~jets, are shown in Tables
\ref{tab:yields_tt_sig}, \ref{tab:yields_zinv_sig} and
\ref{tab:yields_wjetstolnuht_sig} respectively for 1.28\ifb (yields
for 3\ifb are in Appendix~\ref{app:yields3fb}). The contribution from
other sources, such as the single top and diboson channels, was found
to be negligible so are not shown.
Finally,
Table~\ref{tab:yields_ewk_sig} summarises the predicted and observed
yields in the signal region, which again correspond to an integrated
luminosity of 1.28 \ifb. 
