...
The hadronic signal region selection and control regions are detailed in Sec.~\ref{sec:selection}. The relevant data/MC plots are presented here, corresponding to symmetric, asymmetric and monojet selection. The distributions are crucial to understand the MC modeling of key variables. The MC distributions are normalized to 1280.2~$\text{pb}^{-1}$, the data/MC scale factors are shown as well in all figures.
%%____________________________________________________________________________||
\begin{figure}
    \begin{center}
