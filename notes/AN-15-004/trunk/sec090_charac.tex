...
\ref{tab:yields_zinv_sig} and \ref{tab:yields_wjetstolnuht_sig} respectively for 3\ifb. The contribution from
...
\newpage
\input{tables/yields_sig_tt.tex}
\newpage
\input{tables/yields_sig_wjetstolnuht.tex}
\newpage
...
and \ref{tab:yields_ewk_gj} respectively for 3 \ifb. 
