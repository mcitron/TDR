...
Tables~\ref{tab:yieldssep_mu_data_sym}-\ref{tab:yieldssep_mu_data_asym},
\ref{tab:yieldssep_mumu_data_sym}-\ref{tab:yieldssep_mumu_data_asym},
and \ref{tab:yieldssep_gj_data_sym}-\ref{tab:yieldssep_gj_data_asym},
...
Tables~\ref{tab:yieldsnodata_comb_sig_sym} and
\ref{tab:yieldsnodata_comb_sig_asym} summarise the expected yields, as
