...
of the order of 10\% depending on the category. The distribution of this
parameter is shown in Figure~\ref{fig:lastBinError}.
...
\begin{figure}[]
  \centering
  \includegraphics[width=0.5\textwidth]{figures/template/lastBinVariation.pdf}
  \caption{\label{fig:lastBinError} Uncertanties on the final bin
