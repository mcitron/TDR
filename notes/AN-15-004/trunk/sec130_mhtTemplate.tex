...
\begin{figure}[h!]
  ...
  \caption{\label{fig:expectedObservedTtw} Expected relative uncertainties shown for \ttbar/W in Fig.~\ref{fig:expectedTtw} are consistent
  with observed relative uncertainties shown in Fig.~\ref{fig:observedTtw}.}
\end{figure}
