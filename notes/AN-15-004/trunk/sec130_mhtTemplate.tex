...
is critical for removing bias in the \mht dimension. In the gaussian
regime, the p-value of the fits follow a uniform distribution 
between 0 and 1 as shown in Figure ~\ref{fig:pValues}.
...
\begin{figure}[h!]
  \centering
    \includegraphics[width=0.5\textwidth]{figures/template/linear/pValueAll.pdf}
  \\
