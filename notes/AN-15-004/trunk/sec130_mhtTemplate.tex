...
The scale anchoring approach has been validated with 2.1\ifb 
...
\begin{figure}[h!]
  \centering
  \subfigure[\gj]{
    \includegraphics[width=0.5\textwidth]{figures/template13TeV/2p1fb/pull_Linear2DShiftMean_p1_SinglePhoton.pdf}
  }~~
  \subfigure[\mmj]{
    \includegraphics[width=0.5\textwidth]{figures/template13TeV/2p1fb/pull_Linear2DShiftMean_p1_DoubleMu.pdf}
  }\\
  \subfigure[\mj]{
    \includegraphics[width=0.5\textwidth]{figures/template13TeV/2p1fb/pull_Linear2DShiftMean_p1_SingleMu.pdf}
  }~~
  \\
...
\begin{figure}[h!]
  \centering
  \subfigure[\gj]{
    \includegraphics[width=0.5\textwidth]{figures/template13TeV/2p1fb/frenchFlagPull_Linear2DShiftMean_p1_SinglePhoton.pdf}
  }~~
  \subfigure[\mmj]{
    \includegraphics[width=0.5\textwidth]{figures/template13TeV/2p1fb/frenchFlagPull_Linear2DShiftMean_p1_DoubleMu.pdf}
  }\\
  \subfigure[\mj]{
    \includegraphics[width=0.5\textwidth]{figures/template13TeV/2p1fb/frenchFlagPull_Linear2DShiftMean_p1_SingleMu.pdf}
  }~~
  \\
...
\begin{figure}[h!]
  ...
  \subfigure[\label{fig:expectedTtw13} Expected uncertainties]{
    \includegraphics[width=0.5\textwidth]{figures/template13TeV/2p1fb/MCfrenchFlagErrComplete_Linear2DShiftMean_p1_Ttw.pdf}
  }~~
  \subfigure[\label{fig:observedTtw13} Observed uncertainties]{
    \includegraphics[width=0.5\textwidth]{figures/template13TeV/2p1fb/frenchFlagErrComplete_Linear2DShiftMean_p1_Ttw.pdf}
  }\\
...
\begin{figure}[h!]
  ...
  \subfigure[\label{fig:expectedZinv13} Expected uncertainties]{
    \includegraphics[width=0.5\textwidth]{figures/template13TeV/2p1fb/MCfrenchFlagErrComplete_Linear2DShiftMean_p1_Zinv.pdf}
  }~~
  \subfigure[\label{fig:observedZinv13} Observed uncertainties]{
    \includegraphics[width=0.5\textwidth]{figures/template13TeV/2p1fb/frenchFlagErrComplete_Linear2DShiftMean_p1_Zinv.pdf}
  }\\
...
\end{figure}
\newpage
\subsection{Validation with MC based systematic variation}
...
to the nominal template in each jet category and \scalht bin. These systematic effects can then be compared to the
data-driven orthogonal polynomial systematic. 

Figures~\ref{blah} and ~\ref{blah2} show the results of this study for several different \scalht bins and jet-categories.
