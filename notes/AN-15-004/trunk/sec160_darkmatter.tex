...
$M_{\Phi}$ grid points are chosen, roughly equidistant in a logarithmic
...
\begin{figure}[h!]
  \centering
  \subfigure{\includegraphics[width=0.5\textwidth]{figures/DMplots/justVlin.pdf}}
  \subfigure{\includegraphics[width=0.5\textwidth]{figures/DMplots/justVlog.pdf}}
...
\begin{figure}[h!]
  \centering
  \subfigure{\includegraphics[width=0.5\textwidth]{figures/DMplots/justAlin.pdf}}
  \subfigure{\includegraphics[width=0.5\textwidth]{figures/DMplots/justAlog.pdf}}
...
\begin{figure}[h!]
  \centering
  \subfigure{\includegraphics[width=0.5\textwidth]{figures/DMplots/justSlin.pdf}}
  \subfigure{\includegraphics[width=0.5\textwidth]{figures/DMplots/justSlog.pdf}}
...
\begin{figure}[h!]
  \centering
  \subfigure{\includegraphics[width=0.5\textwidth]{figures/DMplots/justPlin.pdf}}
  \subfigure{\includegraphics[width=0.5\textwidth]{figures/DMplots/justPlog.pdf}}
...
\begin{figure}[h!]
  \centering
  \subfigure{\includegraphics[width=0.7\textwidth]{figures/DMplots/DMtt_S_r1.pdf}}
...
While this assumption can lead to stringent validity constraints we still provide a few samples that allow detailed benchmarks and comparisons between experiments and analysis approaches.
...
Table~\ref{tab:dm_dmtt_eft_rvalues} shows the signal strength $\mu$ obtained for 3\fbinv and 10\fbinv. The corresponding exclusion on the reduced mass $M^*$ are shown in Fig.~\ref{fig:limits_EFT}, left.
...
\begin{figure}[h!]
  \centering
  \subfigure{\includegraphics[width=0.5\textwidth]{figures/DMplots/limit_EFT_MJ_90.pdf}}
  \subfigure{\includegraphics[width=0.5\textwidth]{figures/DMplots/limit_DMtt_EFT_90.pdf}}
