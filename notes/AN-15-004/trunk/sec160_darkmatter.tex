...
Corresponding efficiencies and signal yields for nominal, asymmetric and total selection for DM+$b(\bar{b})$ scaled to 3~fb$^{-1}$ can be found in Tables~\ref{tab:dmbb_S},~\ref{tab:dmbb_P}.
