...
\begin{figure}
  ...
  \label{fig:jetRanking}}
  \begin{center}    
    \subfigure[T2tt]{\includegraphics[width=0.5\textwidth]{figures/jetRanking/T2tt/T2tt_bitMap}} ~~
    \subfigure[T2tb]{\includegraphics[width=0.5\textwidth]{figures/jetRanking/T2tb/T2tb_bitMap}} \\
    \subfigure[T2-4bd]{\includegraphics[width=0.5\textwidth]{figures/jetRanking/T2-4bd/T2-4bd_bitMap}} ~~
    \subfigure[T2cc]{\includegraphics[width=0.5\textwidth]{figures/jetRanking/T2cc/T2cc_bitMap}} \\
    \subfigure[T2bW\_X05]{\includegraphics[width=0.5\textwidth]{figures/jetRanking/T2bW_X05/T2bW_X05_bitMap}} ~~
    \subfigure[T2mixed]{\includegraphics[width=0.5\textwidth]{figures/jetRanking/T2mixed/T2mixed_bitMap}} \\
  \end{center}
\end{figure}
...
\begin{figure}
  ...
  \label{fig:jetRanking}}
  \begin{center}    
    \subfigure[T2bb]{\includegraphics[width=0.5\textwidth]{figures/jetRanking/T2bb/T2bb_bitMap}} ~~
