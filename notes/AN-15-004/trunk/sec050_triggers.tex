...
\begin{figure}[h!]
  \begin{center}
    ...
    \caption{
Cumulative trigger efficiency for the {\verb!T1tttt}(1200,800) model after signal selection in the \alphat-\scalht and \mht-\scalht planes for the representative analysis jet multiplicity bins.}
