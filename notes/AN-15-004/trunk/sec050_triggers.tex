...
%----------------------------------------------------------------------
\begin{table}[h!]
\topcaption{Hadronic signal region HLT paths for the Run 2 PU40bx25 scenario, lower threshold Level-1 seeds, HTT150 OR ETM60, are utilised for the PU40bx50 and PU20bx50 scenarios. }
\footnotesize
\centering
...
% Efficiencies table
% T1tttt Rows = AlphaT, MHT: Columns = NJet 4,5
\begin{figure}[h!]
  \begin{center}
    ...
    \caption{
Trigger efficiency after signal selection for T1tttt(X,y) model in representative analysis bins.
   cumulative in \alphaT
(a) $\njet = 4$ and (b) $\njet \geq5$.}
