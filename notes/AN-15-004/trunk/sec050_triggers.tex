...
backgrounds with genuine \met. The trigger efficiency for an example signal model, T1tttt(1200,800), 
is shown in Figure~\ref{fig:T1ttt_Trigger_Efficiency} for the high jet multiplicity analysis bins which are 
representative of the model's typically long decay cascades.
...
\begin{figure}[h!]
  \begin{center}
    ...
    \subfigure[$\njet = 2$]   {\includegraphics[width=0.5\textwidth]{figures/Trigger/T2tt_425_325_eq2j_ht_vs_mht_Cumul.pdf}} ~~
    \subfigure[$\njet \geq 5$]{\includegraphics[width=0.5\textwidth]{figures/Trigger/T1tttt_1200_800_ge5j_ht_vs_mht_Cumul.pdf}} \\
    \caption{
Cumulative trigger efficiency for the T2tt(425,325) T1tttt(1200,800) simplified models after signal selection in the \alphat-\scalht and \mht-\scalht planes for representative analysis jet multiplicity bins.}
