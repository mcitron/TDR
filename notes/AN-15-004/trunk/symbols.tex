...
\newcommand{\gluToTBWNo}{\ensuremath{\sGlunew\,\ra\,\text{t}\text{b}\chipm\,\ra\,\text{t}\text{b}W^{\pm}\chiz}}
...
\newcommand{\stopToBWNo}{\ensuremath{\sTop\,\ra\,\text{b}\chipm(W^{\pm}\chiz)}}
\newcommand{\stopToBFFNo}{\ensuremath{\sTop\,\ra\,\text{b}ff'\chiz}}
\newcommand{\stopToMixed}{\ensuremath{\sTop\,\ra\,\text{c}\chiz/\text{b}\chipm(W^{\pm}\chiz)}}
\newcommand{\stopToTB}{\ensuremath{\sTop\,\ra\,\text{t}\chiz/\text{b}\chipm(W^{\pm}\chiz)}}
\newcommand{\stopToBW}{\ensuremath{\sTop\,\ra\,\text{b}\chipm(W^{\pm}\chiz)}}
