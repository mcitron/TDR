...
Figs.~\ref{fig:simplified-models-feyn-light}-\ref{fig:simplified-models-feyn-3rd}.
...
analysis is shown in Figs.~\ref{fig:T1qqqq_eff}-\ref{fig:T2cc_eff}.
...
In Figs.~\ref{fig:T1qqqq}-\ref{fig:T2cc} (bottom left) the signal
acceptance for each mass point in the SMS scan.

In Figs.~\ref{fig:T1qqqq}-\ref{fig:T2cc} (bottom left) each mass point
