...
\begin{table}[h!]
    ...
    \begin{tabular}{ lllllll }
        ...
        \hline
        T2qq (1-fold) & \ppToSquaSqua & \squarkToQ & \~ & \ref{fig:T2qq_feyn} & \parbox[t]{5cm}{Compressed: (400,300)\\Uncompressed: (700,100)} \\
        \hline
        T2qq (8-fold) & \ppToSquaSqua & \squarkToQ & \~ & \ref{fig:T2qq_feyn} & \parbox[t]{5cm}{Compressed: (700,600)\\Uncompressed: (1250,100)} \\
        \hline \hline
    \end{tabular}
\end{table}
