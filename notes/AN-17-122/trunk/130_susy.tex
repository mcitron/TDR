...
In Figs.~\ref{fig:T1qqqq}-\ref{fig:T2cc} (bottom) the observed significance for
each mass point in the SMS scan is shown.
...
\begin{figure}[h!]
    \begin{center}
        ...
        \caption{Top: the 95\% C.L. observed upper limit on the cross section
            ...
            most sensitive jet categories for each mass point. Bottom: Observed
            significance scan.
        }
        \label{fig:T1qqqq}
    \end{center}
