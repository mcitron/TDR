...
In Fig.~\ref{fig:T1bbbb}-\ref{fig:T2bb} (bottom left) the 4 most sensitive jet
categories for each mass point is shown.
...
\begin{figure}[h!]
    \begin{center}
        ...
        \subfigure[T1bbbb: $\epsilon_{sig}$]{
            \includegraphics[width=0.45\textwidth]{figures/jetRanking/T1bbbb/eff/T1bbbb_effs}
            \label{fig:T1bbbb_eff}
        } ~~
        \subfigure[T1bbbb: Most sensitive categories]{
            \includegraphics[width=0.45\textwidth]{figures/jetRanking/T1bbbb/eff/T1bbbb_bitMap}
...
\begin{figure}[h!]
    \begin{center}
        ...
        \subfigure[T2tt: $\epsilon_{sig}$]{
            \includegraphics[width=0.45\textwidth]{figures/jetRanking/T2tt/eff/T2tt_effs}
            \label{fig:T2tt_eff}
        } ~~
        \subfigure[T2tt: Most sensitive categories]{
            \includegraphics[width=0.45\textwidth]{figures/jetRanking/T2tt/eff/T2tt_bitMap}
...
\begin{figure}[h!]
    \begin{center}
        ...
        \subfigure[T2cc: $\epsilon_{sig}$]{
            \includegraphics[width=0.45\textwidth]{figures/jetRanking/T2cc/eff/T2cc_effs}
            \label{fig:T2cc_eff}
        } ~~
        \subfigure[T2cc: Most sensitive categories]{
            \includegraphics[width=0.45\textwidth]{figures/jetRanking/T2cc/eff/T2cc_bitMap}
...
\begin{figure}[h!]
    \begin{center}
        ...
        \subfigure[T2bb: $\epsilon_{sig}$]{
            \includegraphics[width=0.45\textwidth]{figures/jetRanking/T2bb/eff/T2bb_effs}
            \label{fig:T2bb_eff}
        } ~~
        \subfigure[T2bb: Most sensitive categories]{
            \includegraphics[width=0.45\textwidth]{figures/jetRanking/T2bb/eff/T2bb_bitMap}
