...
Appendix~\ref{app:results-tables} contains tables presenting the data
counts and background expectations in the signal and \mj and \mmj
control regions for the pre-, CR-only, and full fits. 
