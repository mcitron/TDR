...
\begin{figure}[!h]
  ...
  \subfigure[\label{fig:no-fit:mono-asymm}Monojet and asymmetric topologies]{
    \includegraphics[width=0.48\textwidth]{figures/results/36invfb_approval/mht_binned/no-fit/monojet_no-fit.pdf}
  }~ 
  \subfigure[\label{fig:no-fit:dijet}Dijet topologies]{
    \includegraphics[width=0.48\textwidth]{figures/results/36invfb_approval/mht_binned/no-fit/di-jet_no-fit.pdf}
  }\\
  \subfigure[\label{fig:no-fit:three-jet}Topologies with 3 jets]{
    \includegraphics[width=0.48\textwidth]{figures/results/36invfb_approval/mht_binned/no-fit/3jet_no-fit.pdf}
  }~ 
  \subfigure[\label{fig:no-fit:four-jet}Topologies with 4 jets]{
    \includegraphics[width=0.48\textwidth]{figures/results/36invfb_approval/mht_binned/no-fit/4jet_no-fit.pdf}
  }\\
  \subfigure[\label{fig:no-fit:five-jet}Topologies with 5 jets]{
    \includegraphics[width=0.48\textwidth]{figures/results/36invfb_approval/mht_binned/no-fit/5jet_no-fit.pdf}
  }~ 
  \subfigure[\label{fig:no-fit:six-jet}Topologies with $\ge$6 jets]{
    \includegraphics[width=0.48\textwidth]{figures/results/36invfb_approval/mht_binned/no-fit/6+_jets_no-fit.pdf}
  }\\
...
\begin{figure}[!h]
  ...
  \subfigure[\label{fig:cr-fit:mono-asymm}Monojet and asymmetric topologies]{
    \includegraphics[width=0.48\textwidth]{figures/results/36invfb_approval/mht_binned/cr-only/monojet_cr-only.pdf}
  }~ 
  \subfigure[\label{fig:cr-fit:dijet}Dijet topologies]{
    \includegraphics[width=0.48\textwidth]{figures/results/36invfb_approval/mht_binned/cr-only/di-jet_cr-only.pdf}
  }\\
  \subfigure[\label{fig:cr-fit:three-jet}Topologies with 3 jets]{
    \includegraphics[width=0.48\textwidth]{figures/results/36invfb_approval/mht_binned/cr-only/3jet_cr-only.pdf}
  }~ 
  \subfigure[\label{fig:cr-fit:four-jet}Topologies with 4 jets]{
    \includegraphics[width=0.48\textwidth]{figures/results/36invfb_approval/mht_binned/cr-only/4jet_cr-only.pdf}
  }\\
  \subfigure[\label{fig:cr-fit:five-jet}Topologies with 5 jets]{
    \includegraphics[width=0.48\textwidth]{figures/results/36invfb_approval/mht_binned/cr-only/5jet_cr-only.pdf}
  }~ 
  \subfigure[\label{fig:cr-fit:six-jet}Topologies with $\ge$6 jets]{
    \includegraphics[width=0.48\textwidth]{figures/results/36invfb_approval/mht_binned/cr-only/6+_jets_cr-only.pdf}
  }\\
...
\begin{figure}[!h]
  ...
  \subfigure[\label{fig:full-fit:mono-asymm}Monojet and asymmetric topologies]{
    \includegraphics[width=0.48\textwidth]{figures/results/36invfb_approval/mht_binned/full-fit_bg/monojet_full-fit_bg.pdf}
  }~ 
  \subfigure[\label{fig:full-fit:dijet}Dijet topologies]{
    \includegraphics[width=0.48\textwidth]{figures/results/36invfb_approval/mht_binned/full-fit_bg/di-jet_full-fit_bg.pdf}
  }\\
  \subfigure[\label{fig:full-fit:three-jet}Topologies with 3 jets]{
    \includegraphics[width=0.48\textwidth]{figures/results/36invfb_approval/mht_binned/full-fit_bg/3jet_full-fit_bg.pdf}
  }~ 
  \subfigure[\label{fig:full-fit:four-jet}Topologies with 4 jets]{
    \includegraphics[width=0.48\textwidth]{figures/results/36invfb_approval/mht_binned/full-fit_bg/4jet_full-fit_bg.pdf}
  }\\
  \subfigure[\label{fig:full-fit:five-jet}Topologies with 5 jets]{
    \includegraphics[width=0.48\textwidth]{figures/results/36invfb_approval/mht_binned/full-fit_bg/5jet_full-fit_bg.pdf}
  }~ 
  \subfigure[\label{fig:full-fit:six-jet}Topologies with $\ge$6 jets]{
    \includegraphics[width=0.48\textwidth]{figures/results/36invfb_approval/mht_binned/full-fit_bg/6+_jets_full-fit_bg.pdf}
  }\\
