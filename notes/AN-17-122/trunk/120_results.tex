...
\begin{figure}[!h]
  ...
  \subfigure[\label{fig:no-fit:mono-asymm}Monojet and asymmetric topologies]{
    \includegraphics[width=0.48\textwidth]{figures/mountainRangePlots/full_binning_no_sig/monojet_no-fit.pdf}
  }~ 
  \subfigure[\label{fig:no-fit:dijet}Dijet topologies]{
    \includegraphics[width=0.48\textwidth]{figures/mountainRangePlots/full_binning_no_sig/di-jet_no-fit.pdf}
  }\\
  \subfigure[\label{fig:no-fit:three-jet}Topologies with 3 jets]{
    \includegraphics[width=0.48\textwidth]{figures/mountainRangePlots/full_binning_no_sig/3jet_no-fit.pdf}
  }~ 
  \subfigure[\label{fig:no-fit:four-jet}Topologies with 4 jets]{
    \includegraphics[width=0.48\textwidth]{figures/mountainRangePlots/full_binning_no_sig/4jet_no-fit.pdf}
  }\\
  \subfigure[\label{fig:no-fit:five-jet}Topologies with 5 jets]{
    \includegraphics[width=0.48\textwidth]{figures/mountainRangePlots/full_binning_no_sig/5jet_no-fit.pdf}
  }~ 
  \subfigure[\label{fig:no-fit:six-jet}Topologies with $\ge$6 jets]{
    \includegraphics[width=0.48\textwidth]{figures/mountainRangePlots/full_binning_no_sig/6+_jets_no-fit.pdf}
  }\\
...
\begin{figure}[!h]
  ...
  \subfigure[\label{fig:cr-fit:mono-asymm}Monojet and asymmetric topologies]{
    \includegraphics[width=0.48\textwidth]{figures/mountainRangePlots/full_binning_no_sig/monojet_cr-only.pdf}
  }~ 
  \subfigure[\label{fig:cr-fit:dijet}Dijet topologies]{
    \includegraphics[width=0.48\textwidth]{figures/mountainRangePlots/full_binning_no_sig/di-jet_cr-only.pdf}
  }\\
  \subfigure[\label{fig:cr-fit:three-jet}Topologies with 3 jets]{
    \includegraphics[width=0.48\textwidth]{figures/mountainRangePlots/full_binning_no_sig/3jet_cr-only.pdf}
  }~ 
  \subfigure[\label{fig:cr-fit:four-jet}Topologies with 4 jets]{
    \includegraphics[width=0.48\textwidth]{figures/mountainRangePlots/full_binning_no_sig/4jet_cr-only.pdf}
  }\\
  \subfigure[\label{fig:cr-fit:five-jet}Topologies with 5 jets]{
    \includegraphics[width=0.48\textwidth]{figures/mountainRangePlots/full_binning_no_sig/5jet_cr-only.pdf}
  }~ 
  \subfigure[\label{fig:cr-fit:six-jet}Topologies with $\ge$6 jets]{
    \includegraphics[width=0.48\textwidth]{figures/mountainRangePlots/full_binning_no_sig/6+_jets_cr-only.pdf}
  }\\
...
\begin{figure}[!h]
  ...
  \subfigure[\label{fig:full-fit:mono-asymm}Monojet and asymmetric topologies]{
    \includegraphics[width=0.48\textwidth]{figures/mountainRangePlots/full_binning_no_sig/monojet_full-fit-bg.pdf}
  }~ 
  \subfigure[\label{fig:full-fit:dijet}Dijet topologies]{
    \includegraphics[width=0.48\textwidth]{figures/mountainRangePlots/full_binning_no_sig/di-jet_full-fit-bg.pdf}
  }\\
  \subfigure[\label{fig:full-fit:three-jet}Topologies with 3 jets]{
    \includegraphics[width=0.48\textwidth]{figures/mountainRangePlots/full_binning_no_sig/3jet_full-fit-bg.pdf}
  }~ 
  \subfigure[\label{fig:full-fit:four-jet}Topologies with 4 jets]{
    \includegraphics[width=0.48\textwidth]{figures/mountainRangePlots/full_binning_no_sig/4jet_full-fit-bg.pdf}
  }\\
  \subfigure[\label{fig:full-fit:five-jet}Topologies with 5 jets]{
    \includegraphics[width=0.48\textwidth]{figures/mountainRangePlots/full_binning_no_sig/5jet_full-fit-bg.pdf}
  }~ 
  \subfigure[\label{fig:full-fit:six-jet}Topologies with $\ge$6 jets]{
    \includegraphics[width=0.48\textwidth]{figures/mountainRangePlots/full_binning_no_sig/6+_jets_full-fit-bg.pdf}
  }\\
