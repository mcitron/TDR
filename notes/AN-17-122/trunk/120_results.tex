...
\begin{figure}[!h]
  ...
  \subfigure[\label{fig:no-fit:mono-asymm}Monojet and asymmetric topologies]{
    \includegraphics[width=0.48\textwidth]{figures/results/36invfb_nlo_fix/mountainRangePlots/full_binning_no_sig/monojet_no-fit.pdf}
  }~ 
  \subfigure[\label{fig:no-fit:dijet}Dijet topologies]{
    \includegraphics[width=0.48\textwidth]{figures/results/36invfb_nlo_fix/mountainRangePlots/full_binning_no_sig/di-jet_no-fit.pdf}
  }\\
  \subfigure[\label{fig:no-fit:three-jet}Topologies with 3 jets]{
    \includegraphics[width=0.48\textwidth]{figures/results/36invfb_nlo_fix/mountainRangePlots/full_binning_no_sig/3jet_no-fit.pdf}
  }~ 
  \subfigure[\label{fig:no-fit:four-jet}Topologies with 4 jets]{
    \includegraphics[width=0.48\textwidth]{figures/results/36invfb_nlo_fix/mountainRangePlots/full_binning_no_sig/4jet_no-fit.pdf}
  }\\
  \subfigure[\label{fig:no-fit:five-jet}Topologies with 5 jets]{
    \includegraphics[width=0.48\textwidth]{figures/results/36invfb_nlo_fix/mountainRangePlots/full_binning_no_sig/5jet_no-fit.pdf}
  }~ 
  \subfigure[\label{fig:no-fit:six-jet}Topologies with $\ge$6 jets]{
    \includegraphics[width=0.48\textwidth]{figures/results/36invfb_nlo_fix/mountainRangePlots/full_binning_no_sig/6+_jets_no-fit.pdf}
  }\\
...
\begin{figure}[!h]
  ...
  \subfigure[\label{fig:cr-fit:mono-asymm}Monojet and asymmetric topologies]{
    \includegraphics[width=0.48\textwidth]{figures/results/36invfb_nlo_fix/mountainRangePlots/full_binning_no_sig/monojet_cr-only.pdf}
  }~ 
  \subfigure[\label{fig:cr-fit:dijet}Dijet topologies]{
    \includegraphics[width=0.48\textwidth]{figures/results/36invfb_nlo_fix/mountainRangePlots/full_binning_no_sig/di-jet_cr-only.pdf}
  }\\
  \subfigure[\label{fig:cr-fit:three-jet}Topologies with 3 jets]{
    \includegraphics[width=0.48\textwidth]{figures/results/36invfb_nlo_fix/mountainRangePlots/full_binning_no_sig/3jet_cr-only.pdf}
  }~ 
  \subfigure[\label{fig:cr-fit:four-jet}Topologies with 4 jets]{
    \includegraphics[width=0.48\textwidth]{figures/results/36invfb_nlo_fix/mountainRangePlots/full_binning_no_sig/4jet_cr-only.pdf}
  }\\
  \subfigure[\label{fig:cr-fit:five-jet}Topologies with 5 jets]{
    \includegraphics[width=0.48\textwidth]{figures/results/36invfb_nlo_fix/mountainRangePlots/full_binning_no_sig/5jet_cr-only.pdf}
  }~ 
  \subfigure[\label{fig:cr-fit:six-jet}Topologies with $\ge$6 jets]{
    \includegraphics[width=0.48\textwidth]{figures/results/36invfb_nlo_fix/mountainRangePlots/full_binning_no_sig/6+_jets_cr-only.pdf}
  }\\
...
\begin{figure}[!h]
  ...
  \subfigure[\label{fig:full-fit:mono-asymm}Monojet and asymmetric topologies]{
    \includegraphics[width=0.48\textwidth]{figures/results/36invfb_nlo_fix/mountainRangePlots/full_binning_no_sig/monojet_full-fit-bg.pdf}
  }~ 
  \subfigure[\label{fig:full-fit:dijet}Dijet topologies]{
    \includegraphics[width=0.48\textwidth]{figures/results/36invfb_nlo_fix/mountainRangePlots/full_binning_no_sig/di-jet_full-fit-bg.pdf}
  }\\
  \subfigure[\label{fig:full-fit:three-jet}Topologies with 3 jets]{
    \includegraphics[width=0.48\textwidth]{figures/results/36invfb_nlo_fix/mountainRangePlots/full_binning_no_sig/3jet_full-fit-bg.pdf}
  }~ 
  \subfigure[\label{fig:full-fit:four-jet}Topologies with 4 jets]{
    \includegraphics[width=0.48\textwidth]{figures/results/36invfb_nlo_fix/mountainRangePlots/full_binning_no_sig/4jet_full-fit-bg.pdf}
  }\\
  \subfigure[\label{fig:full-fit:five-jet}Topologies with 5 jets]{
    \includegraphics[width=0.48\textwidth]{figures/results/36invfb_nlo_fix/mountainRangePlots/full_binning_no_sig/5jet_full-fit-bg.pdf}
  }~ 
  \subfigure[\label{fig:full-fit:six-jet}Topologies with $\ge$6 jets]{
    \includegraphics[width=0.48\textwidth]{figures/results/36invfb_nlo_fix/mountainRangePlots/full_binning_no_sig/6+_jets_full-fit-bg.pdf}
  }\\
...
%\ref{fig:aggregated_results3}, and \ref{fig:aggregated_results4} 
...
%
%\newcommand{\customcaptiontwo}[6]{As Fig.~\ref{#6}, but for for events 
%  in the #1 topology that are required to satisfy #2, #3, and
%  (\cmsLeft) #4 or (\cmsRight) #5.}
%
%\clearpage
%\begin{figure}[h!]
%  \centering
...
%  }
%  \includegraphics[width=0.45\linewidth]{figures/results/36invfb_approval/aggregated/postFitShapeCR/mhtShape_eq0b_ge1j2a_200_Inf_crfit.pdf} ~
%  \includegraphics[width=0.45\linewidth]{figures/results/36invfb_approval/aggregated/postFitShapeCR/mhtShape_ge1b_ge1j2a_200_Inf_crfit.pdf} 
...
%  \centering
%  \caption{
%    \customcaptiontwo{``low \njet''}{$2 \leq \njet \leq 3$}{$\scalht > 200\GeV$}{$0 \leq \nb \leq 1$}{$\nb \geq 2$}{fig:aggregated_results1}
%  }
%  \includegraphics[width=0.45\linewidth]{figures/results/36invfb_approval/aggregated/postFitShapeCR/mhtShape_eq01b_eq23j_200_Inf_crfit.pdf} ~
%  \includegraphics[width=0.45\linewidth]{figures/results/36invfb_approval/aggregated/postFitShapeCR/mhtShape_ge2b_eq23j_200_Inf_crfit.pdf} 
...
%  \centering
%  \caption{
%    \customcaptiontwo{``medium \njet''}{$4 \leq \njet \leq 5$}{$\scalht > 400\GeV$}{$0 \leq \nb \leq 1$}{$\nb \geq 2$}{fig:aggregated_results1}
%  }
%  \includegraphics[width=0.45\linewidth]{figures/results/36invfb_approval/aggregated/postFitShapeCR/mhtShape_eq01b_eq45j_400_Inf_crfit.pdf} ~
%  \includegraphics[width=0.45\linewidth]{figures/results/36invfb_approval/aggregated/postFitShapeCR/mhtShape_ge2b_eq45j_400_Inf_crfit.pdf} 
...
%  \centering
%    \caption{
%      \customcaptiontwo{``high \njet''}{$\njet \geq 6$}{$\scalht > 400\GeV$}{$0 \leq \nb \leq 1$}{$\nb \geq 2$}{fig:aggregated_results1}
%    }
%  \includegraphics[width=0.45\linewidth]{figures/results/36invfb_approval/aggregated/postFitShapeCR/mhtShape_eq01b_ge6j_400_Inf_crfit.pdf} ~
%  \includegraphics[width=0.45\linewidth]{figures/results/36invfb_approval/aggregated/postFitShapeCR/mhtShape_ge2b_ge6j_400_Inf_crfit.pdf}
