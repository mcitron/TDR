...
\newcommand{\zllj}{\ensuremath{{\rm Z}(\rightarrow\ell\ell) + \textrm{jets}}\xspace}
\newcommand{\znunuj}{\ensuremath{{\rm Z}(\rightarrow\nu\bar{\nu}) + \textrm{jets}}\xspace}
...
\newcommand{\bbNew}{\ensuremath{\rm{b}\bar{\rm{b}}}\xspace}
\newcommand{\tev}{\TeV}
%<TW date="30/10/2010">
%\newcommand{\Et}{E_{T}}
...
\def\HTmiss{\mbox{$H_{\rm T}^{\rm miss}$}\xspace}
...
\def\bdphilow{\mbox{$\Delta\phi^{*\,25}_{\rm min}$}\xspace}
...
\def\nisr{\ensuremath{n_\textrm{jet}^\mathrm{ISR}}\xspace}

\newcommand{\zero}{\ensuremath{\phantom{0}}}
\newcommand{\flepAccep}{\ensuremath{f_{sample}}\xspace}
\newcommand{\superscript}[1]{\ensuremath{^{\mathrm{#1}}}\xspace}
\newcommand{\subscript}[1]{\ensuremath{_{\mathrm{#1}}}\xspace}
