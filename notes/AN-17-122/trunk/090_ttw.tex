...
\begin{table}[h!]
  \caption{Sources of systematic uncertainty in the transfer factors
    ...
    region. Also shown are the correlating assumptions used and
    representative magnitudes for the uncertainties [\%]. 
  }   
  \label{tab:systs-ttw}
  \centering
  \footnotesize
  \begin{tabular}{ lll }
    \hline
    Source of uncertainty               & Nuisance parameters (\ie correlation scheme)     & Magnitude                        \\
    \hline
    Minimum bias cross section (pileup) & 1 for all (\njet, \scalht, \nb, \mht) categories & X--Y\%                           \\
