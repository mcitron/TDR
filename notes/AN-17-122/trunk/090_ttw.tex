...
\begin{table}[h!]
  \caption{Sources of systematic uncertainty in the transfer factors
    ...
    the nuisance parameters are unique to the lost lepton background
    or shared with the \znunuj background estimate
    (see Table~\ref{tab:systs-zinv}).
  }
  \label{tab:systs-ttw}
  \centering
  ...
  \begin{tabular}{ llllc }
    ...
    Lepton efficiency (veto)            & 1, correlated across \cat           & 2.5--15.                                    & Unique & \ref{fig:tfSyst_leptonveto_muToTtw} \\
...
Fig.~\ref{fig:NLO_app} (also App.~\ref{app:ttw}) show the effects of the NLO
