...
%    QCD NLO corrections                 & 1.5--3.8                         & 2.3--12.7          & Shared & \ref{fig:tfSyst_nlo_muToTtw}        \\
%    EWK NLO corrections                 & 0.1--3.8                         & 1.7--9.5           & Shared & \ref{fig:tfSyst_nlo_muToTtw}        \\
...
%Uncertainties in the transfer factors are typically at the percent
%level and as large as $\sim 4\%$. The uncertainties in the \mht
%dimension can be as large as ${\sim}13\%$. 
Fig.~\ref{fig:NLO_app_ttw} (also App.~\ref{app:ttw}) shows the effects
of the NLO corrections on the event yield in each bin in the signal
region.
