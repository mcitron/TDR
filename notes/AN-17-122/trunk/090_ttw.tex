...
$\sim 4\%$. The uncertainties in the \mht dimension can be as large as
${\sim}13\%$. Fig.~\ref{fig:NLO_app_ttw} (also App.~\ref{app:ttw})
shows the effects of the NLO corrections on the event yield in each
