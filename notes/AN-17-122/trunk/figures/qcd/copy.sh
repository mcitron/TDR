...
wgetr ${DIR}/Estimation/QcdSb/qcdSbEwk_MC.pdf		   
...
wgetr ${DIR}/Estimation/BDPhiSb/qcdSbEwk_MC.pdf		   
...
wgetr ${DIR}/Estimation/DoubleSb/qcdSbEwk_MC.pdf		   
wgetr ${DIR}/Estimation/DoubleSb/rateParsQcd_QcdSb.pdf
cd ../

cd sb_mhtmet/
wgetr ${DIR}/Estimation/QcdSb/predictedQcdYields_Signal.pdf
wgetr ${DIR}/Estimation/QcdSb/predictedEwkYields_Signal.pdf
wgetr ${DIR}/Estimation/QcdSb/predictedQcdDivEwk_Signal.pdf
cd ../
