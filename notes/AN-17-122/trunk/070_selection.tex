...
\begin{table}[h!]
  ...
  \begin{tabular}{ lccccccc }
    \hline
    \scalht           & 200--250 & 250--300 & 300--350 & 350--400 & 400--900 & $>$900 \\
    \alphat threshold & 0.65     & 0.60     & 0.55     & 0.53     & 0.52     & (none) \\
    \hline
  \end{tabular}
\end{table}
...
\begin{table}[!h]
  ...
  \begin{tabular}{ ll }
    ...
    Multijet & Signal region selection (Table~\ref{}) two inverted requirements: $\HTmiss/\ETmiss > 1.25$ and $\bdphi < 0.5$  \\
    \hline
  \end{tabular}
\end{table}
