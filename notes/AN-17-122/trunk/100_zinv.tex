...
\begin{table}[h!]
  ...
  \begin{tabular}{ llllc }
    ...
    QCD NLO corrections                 & 2.6--15.8                        & 5.1--17.0          & Shared & \ref{fig:tfSyst_nlo_mmZinv}     \\
    EWK NLO corrections                 & 0.0--7.1                         & 3.2--7.8           & Shared & \ref{fig:tfSyst_nlo_mmZinv}     \\
...
transfer factors are typically at the few percent level, and can be as
large as ${\sim}15\%$, while uncertainties in the \mht dimension can
be as large as ${\sim}17\%$. Fig.~\ref{fig:NLO_app_zinv} (also
App.~\ref{app:zinv}) shows the effects of the NLO corrections on the
event yield in each bin in the signal region.
