...
\begin{figure}[!h]
  \centering
  \subfigure[\label{fig:NLO:Zinv:mono-asymm}Monojet and asymmetric topologies]{
    \includegraphics[width=0.48\textwidth]{figures/results/36invfb_nlo_fix/mountainRangePlots/NLO/Zinv_monojet_no-fit_dists_.pdf}
  }~ 
  \subfigure[\label{fig:NLO:Zinv:dijet}Dijet topologies]{
    \includegraphics[width=0.48\textwidth]{figures/results/36invfb_nlo_fix/mountainRangePlots/NLO/Zinv_di-jet_no-fit_dists_.pdf}
  }\\
  \subfigure[\label{fig:NLO:Zinv:three-jet}Topologies with 3 jets]{
    \includegraphics[width=0.48\textwidth]{figures/results/36invfb_nlo_fix/mountainRangePlots/NLO/Zinv_3jet_no-fit_dists_.pdf}
  }~ 
  \subfigure[\label{fig:NLO:Zinv:four-jet}Topologies with 4 jets]{
    \includegraphics[width=0.48\textwidth]{figures/results/36invfb_nlo_fix/mountainRangePlots/NLO/Zinv_4jet_no-fit_dists_.pdf}
  }\\
  \subfigure[\label{fig:NLO:Zinv:five-jet}Topologies with 5 jets]{
    \includegraphics[width=0.48\textwidth]{figures/results/36invfb_nlo_fix/mountainRangePlots/NLO/Zinv_5jet_no-fit_dists_.pdf}
  }~ 
  \subfigure[\label{fig:NLO:Zinv:six-jet}Topologies with $\ge$6 jets]{
    \includegraphics[width=0.48\textwidth]{figures/results/36invfb_nlo_fix/mountainRangePlots/NLO/Zinv_6+_jets_no-fit_dists_.pdf}
  }\\
