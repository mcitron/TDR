...
\begin{figure}[!h]
  ...
  \subfigure[\label{fig:NLO:Ttw:mono-asymm}Monojet and asymmetric topologies]{
    \includegraphics[width=0.48\textwidth]{figures/mountainRangePlots/NLO/Ttw_monojet_no-fit_dists_.pdf}
  }~ 
  \subfigure[\label{fig:NLO:Ttw:dijet}Dijet topologies]{
    \includegraphics[width=0.48\textwidth]{figures/mountainRangePlots/NLO/Ttw_di-jet_no-fit_dists_.pdf}
  }\\
  \subfigure[\label{fig:NLO:Ttw:three-jet}Topologies with 3 jets]{
    \includegraphics[width=0.48\textwidth]{figures/mountainRangePlots/NLO/Ttw_3jet_no-fit_dists_.pdf}
  }~ 
  \subfigure[\label{fig:NLO:Ttw:four-jet}Topologies with 4 jets]{
    \includegraphics[width=0.48\textwidth]{figures/mountainRangePlots/NLO/Ttw_4jet_no-fit_dists_.pdf}
  }\\
  \subfigure[\label{fig:NLO:Ttw:five-jet}Topologies with 5 jets]{
    \includegraphics[width=0.48\textwidth]{figures/mountainRangePlots/NLO/Ttw_5jet_no-fit_dists_.pdf}
  }~ 
  \subfigure[\label{fig:NLO:Ttw:six-jet}Topologies with $\ge$6 jets]{
    \includegraphics[width=0.48\textwidth]{figures/mountainRangePlots/NLO/Ttw_6+_jets_no-fit_dists_.pdf}
  }\\
