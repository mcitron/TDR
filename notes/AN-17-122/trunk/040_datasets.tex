...
generator-level information contained in the simulation.
The number of
...
and the average b-tag and mis-tag efficiencies,
$\epsilon$, $f_{\rm c}$, and $f_{\rm LF}$
independently of $n_{\rm b}$, allowing for 
event yields for a given b-quark jet multiplicity to
be predicted with a higher statistical precision than obtained
directly from simulation.
Precise measurements of $f_{\rm c}$ and
