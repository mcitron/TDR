...
The signal region has been partially unblinded. A sub-sample of events
selecting 1 in 8 from the certified data set is used, which
corresponds to an integrated luminosity of 4.5~\ifb.
