...
\begin{figure}[h!]
    \begin{center}
        ...
        \caption{
            Pre-fit T1qqqq compressed benchmark model overlay on CR-only
...
\begin{figure}[h!]
    \begin{center}
        ...
        \caption{
            Pre-fit T1qqqq uncompressed benchmark model overlay on CR-only
            post-fit background prediction for all analysis bins. The
            uncertainty on the signal model counts represents the statistical
            uncertainty due to the finite size of the of the simulated sample.
        }
...
\begin{figure}[h!]
    \begin{center}
        ...
        \caption{
            Pre-fit T1bbbb uncompressed benchmark model overlay on CR-only
            post-fit background prediction for all analysis bins. The
            uncertainty on the signal model counts represents the statistical
            uncertainty due to the finite size of the of the simulated sample.
        }
...
\begin{figure}[h!]
    \begin{center}
        \subfigure[Compressed]{
            \includegraphics[width=0.7\textwidth]{figures/susyResults/app/T2qq_mGluino-400_mLSP-300/all_full-fit-sig}
            \label{fig:T2qq_1fold_compressed_MR_simp}
        } \\
        \subfigure[Uncompressed]{
            \includegraphics[width=0.7\textwidth]{figures/susyResults/app/T2qq_mGluino-700_mLSP-100/all_full-fit-sig}
...
\begin{figure}[h!]
    \begin{center}
        \subfigure[Compressed]{
            \includegraphics[width=0.7\textwidth]{figures/susyResults/app/T2qq_mGluino-700_mLSP-600/all_full-fit-sig}
            \label{fig:T2qq_8fold_compressed_MR_simp}
        } \\
        \subfigure[Uncompressed]{
            \includegraphics[width=0.7\textwidth]{figures/susyResults/app/T2qq_mGluino-1250_mLSP-100/all_full-fit-sig}
...
\begin{figure}[h!]
    \begin{center}
        \subfigure[Compressed]{
            \includegraphics[width=0.7\textwidth]{figures/susyResults/app/T2bb_mGluino-550_mLSP-450/all_full-fit-sig}
            \label{fig:T2bb_compressed_MR_simp}
        } \\
        \subfigure[Uncompressed]{
            \includegraphics[width=0.7\textwidth]{figures/susyResults/app/T2bb_mGluino-1000_mLSP-100/all_full-fit-sig}
...
\begin{figure}[h!]
    \begin{center}
        \subfigure[Compressed]{
            \includegraphics[width=0.7\textwidth]{figures/susyResults/app/T2tt_mGluino-450_mLSP-200/all_full-fit-sig}
            \label{fig:T2tt_compressed_MR_simp}
        } \\
        \subfigure[Uncompressed]{
            \includegraphics[width=0.7\textwidth]{figures/susyResults/app/T2tt_mGluino-1000_mLSP-50/all_full-fit-sig}
            \label{fig:T2tt_uncompressed_MR_simp}
        } \\
        \subfigure[$W$ corridor]{
            \includegraphics[width=0.7\textwidth]{figures/susyResults/app/T2tt_mGluino-250_mLSP-150/all_full-fit-sig}
...
\begin{figure}[h!]
    \begin{center}
        \subfigure[Compressed]{
            \includegraphics[width=0.7\textwidth]{figures/susyResults/app/T2cc_mGluino-500_mLSP-480/all_full-fit-sig}
