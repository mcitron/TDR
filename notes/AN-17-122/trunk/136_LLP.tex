...
\begin{table}[h!]
    ...
    \begin{tabular}{ ccccccccccc }
      ...
      & Luminosity & ISR   & JECs   & PU     & Trigger & b-tag & mis-tag & odd jet & MC stat. \\ 
      \hline
      \multirow{2}{*}{0.001}
      & (1800,200) & 2.6\% & 3-5\%  & 3-9\%  & 1-3\% & 3-4\% & 0-1\%   & 32-73\% & 0-1\%  & 8-20\%  \\
      & (1000,900) & 2.6\% & 2-10\% & 4-14\% & 1-3\% & 0-3\% & 0-1\%   & 10-20\% & 0-1\%  & 15-21\% \\
      \hline
      \multirow{2}{*}{1}
      & (1800,200) & 2.6\% & 2-5\%  & 3-9\%  & 1-3\% & 3-4\% & 17-59\% & 8-28\%  & 1-1\%  & 11-20\% \\
      & (1000,900) & 2.6\% & 2-9\%  & 4-17\% & 1-5\% & 1-2\% & 10-41\% & 2-9\%   & 0-1\%  & 17-26\% \\
      \hline
      \multirow{2}{*}{100000}
      & (1000,200) & 2.6\% & 2-14\% & 4-9\%  & 0-3\% & 0-2\% & 0-1\%   & 0-1\%   & 5-13\% & 16-22\% \\
      & (1000,900) & 2.6\% & 3-14\% & 2-12\% & 2-5\% & 0-2\% & 0-0\%   & 0-1\%   & 6-11\% & 14-26\% \\
      \hline \hline
    \end{tabular}
\end{table}
