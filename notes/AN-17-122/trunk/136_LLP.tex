...
%  Most sensitive simplified $n_{\mathrm{jet}}$, $n_{\mathrm{b}}$ category & \phantom{10}7.4 & \phantom{10}0.6 \\
  \hline
\end{tabular}
}
\end{table}
...
%  Most sensitive simplified $n_{\mathrm{jet}}$, $n_{\mathrm{b}}$ category & \phantom{10}6.0 & \phantom{10}0.5 \\
  \hline
\end{tabular}
}
\end{table}
...
%  Most sensitive simplified $n_{\mathrm{jet}}$, $n_{\mathrm{b}}$ category & \phantom{10}1.7 & \phantom{10}2.1 \\
  \hline
\end{tabular}
}
\end{table}
