...
Table~\ref{tab:benchmark-LLP} summarises the benchmark models, defined
...
Table~\ref{tab:benchmark-LLP}. \fixme{Tables to be updated.}
...
\begin{figure}[!h]
  \centering
  \subfigure[$c\tau = 0.001\unit{mm}$, T1qqqqLL $(1800,200)$]{
  ...
  \subfigure[$c\tau = 0.001\unit{mm}$, T1qqqqLL $(1000,900)$]{
  ...
  \subfigure[$c\tau = 1\unit{mm}$, T1qqqqLL $(1800,200)$]{
  ...
  \subfigure[$c\tau = 1\unit{mm}$, T1qqqqLL $(1000,900)$]{
  ...
  \subfigure[$c\tau = 100000\unit{mm}$, T1qqqqLL $(1000,200)$]{
  ...
  \subfigure[$c\tau = 100000\unit{mm}$, T1qqqqLL $(1000,900)$]{
