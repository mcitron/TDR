...
\begin{figure}[!ht]
    \centering
    \subfigure[$c\tau=10~\mu\mathrm{m}$, uncompressed $(1800,200)$]{
    ...
    \subfigure[$c\tau=10~\mu\mathrm{m}$, compressed $(1000,900)$]{
    ...
    \subfigure[$c\tau=1~\mathrm{mm}$, uncompressed $(1800,200)$]{
    ...
    \subfigure[$c\tau=1~\mathrm{mm}$, compressed $(1000,900)$]{
    ...
    \subfigure[\ctau=100~m, uncompressed $(1000,200)$]{
    ...
    \subfigure[\ctau=100~m, compressed $(1000,900)$]{
