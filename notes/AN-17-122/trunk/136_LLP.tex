...
\begin{figure}[!ht]
    ...
    \subfigure[$c\tau=1\unit{mm}$, compressed $(1000,900)$]{
        \includegraphics[width=0.49\textwidth]{figures/susyLLResults/app/T1qqqqLL_ctau_1_mGluino-1000_mLSP-900/all_full-fit-sig}
...
\begin{figure}[!ht]
    \centering
    \subfigure[$c\tau=0.001\unit{mm}$, uncompressed $(1800,200)$]{
        \includegraphics[width=0.49\textwidth]{figures/susyLLResults/app/T1qqqqLL_ctau_0p001_mGluino-1800_mLSP-200/with-signal_full-fit-sig}
        \label{fig:T1qqqqLL_ctau_0p001_uncompressed_MR_simp_with_signal}
    } ~~
    \subfigure[$c\tau=0.001\unit{mm}$, compressed $(1000,900)$]{
        \includegraphics[width=0.49\textwidth]{figures/susyLLResults/app/T1qqqqLL_ctau_0p001_mGluino-1000_mLSP-900/with-signal_full-fit-sig}
        \label{fig:T1qqqqLL_ctau_0p001_compressed_MR_simp_with_signal}
    } \\
    \subfigure[$c\tau=1\unit{mm}$, uncompressed $(1800,200)$]{
        \includegraphics[width=0.49\textwidth]{figures/susyLLResults/app/T1qqqqLL_ctau_1_mGluino-1800_mLSP-200/with-signal_full-fit-sig}
        \label{fig:T1qqqqLL_ctau_1_compressed_MR_simp_with_signal}
    } ~~
    \subfigure[$c\tau=1\unit{mm}$, compressed $(1000,900)$]{
        \includegraphics[width=0.49\textwidth]{figures/susyLLResults/app/T1qqqqLL_ctau_1_mGluino-1000_mLSP-900/with-signal_full-fit-sig}
        \label{fig:T1qqqqLL_ctau_1_uncompressed_MR_simp_with_signal}
    } \\
    \subfigure[$\ctau=100000\unit{mm}$, uncompressed $(1000,200)$]{
        \includegraphics[width=0.49\textwidth]{figures/susyLLResults/app/T1qqqqLL_ctau_100000_mGluino-1000_mLSP-200/with-signal_full-fit-sig}
        \label{fig:T1qqqqLL_ctau_100000_compressed_MR_simp_with_signal}
    } ~~
    \subfigure[$\ctau=100000\unit{mm}$, compressed $(1000,900)$]{
        \includegraphics[width=0.49\textwidth]{figures/susyLLResults/app/T1qqqqLL_ctau_100000_mGluino-1000_mLSP-900/with-signal_full-fit-sig}
