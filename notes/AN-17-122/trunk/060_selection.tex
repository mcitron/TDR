...
\begin{table}[h!]
  \caption{\alphat thresholds versus
    ...
    imposed for events satisfying $\njet = 1$ (``monojet'' events, see
    Sec.~\ref{sec:subleading-jet}), nor $\scalht > 1200\GeV$.} 
...
they satisfy $\bdphi > 0.5$. In the case of events satisfying $\njet =
1$ (``monojet'' events, see Sec.~\ref{sec:subleading-jet}), the
...
\subsubsection{Event categorisation by subleading jet \Pt}
...
\subsubsection{Event categorisation by \njet}
...
\subsubsection{Event categorisation by \scalht}
...
\begin{table}[!h]
  \topcaption{Summary of the lower bound of the first \scalht bin as a
    function of \njet category used in the analysis. 
  }
  \label{tab:sr-ht-binning}
  \centering
  \begin{tabular}{ lccccccc }
    \hline
    \njet         & eq1j & eq2a & eq2j & eq3j & eq4j & eq5j & ge6j \\
...
%\newcommand{\gef}{$\geq$4}
%\begin{table}[!h]
%  \topcaption{Summary of the final event categorisation used in the
%    signal region. Each entry in the table represents the value of \nb 
%    that defines the lower bound of the final bin, as a function of 
%    \njet and the lower bound of each \scalht bin [GeV]. The dashes
%    (--) signify that the (\njet, \scalht) bin is not used.  
%  }
%  \label{tab:sr-binning}
%  \centering
%  \begin{tabular}{ lccccc }
%    \hline
%    $\njet \backslash\, \scalht$ [GeV] & 200 & 400  & 600 & 900 & $>$1200 \\
%    \hline
%    1                                  & 1   & 1    & 1   & --  & --      \\ 
%    2a                                 & 3   & 3    & 3   & 2   & --      \\ 
%    2                                  & 2   & 2    & 2   & 2   & 1       \\ 
...
\subsubsection{Event categorisation by \HTmiss}
\label{sec} 
...
\begin{table}[!h]
  \topcaption{Summary of the lower bound of the final \HTmiss bin
    [GeV] as a function of \njet and \scalht. The lower bound of the
    first \scalht bin is summarised in
    Table~\ref{tab:sr-ht-binning}. The dashes (--) signify (\njet,
  ...
  \begin{tabular}{ lccccc }
    \hline
    $\njet\, / \,\nb$ & 200 & 400 & 600 & 900  & $>$1200 \\
    \hline
    eq1j              & 300 & 500 & 800 & 1000 & --      \\ 
    eq2a              & 300 & 500 & 800 & 1000 & --      \\ 
    eq2j              & 300 & 500 & 800 & 1000 & 1000    \\ 
    eq3j              & 300 & 500 & 800 & 1000 & 1000    \\ 
    eq4j              & --  & 500 & 800 & 1000 & 1000    \\ 
    eq5j              & --  & 500 & 800 & 1000 & 1000    \\ 
    ge6j              & --  & 500 & 800 & 1000 & 1000    \\ 
    \hline
  \end{tabular}
\end{table}
