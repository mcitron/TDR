...
The number multijet events passing/failing the $\mhtmet < 1.25$ requirement is then determined for simulations for each of these bins. 
...
%  \centering
%  \subfigure{
%    \includegraphics[width=0.8\textwidth]{AN-15-004/trunk/figures/qcd/v6/DataNoEwk_SigTrig_QCDPredDivEwk_NJet_vs_HT_bDPhigt0p5_Log.pdf}
%  } \\
