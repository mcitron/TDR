...
\item \textbf{Data/MC correction factors}. The following data/MC scale factors (SF) have been used in this iteration of the analysis. 
  ...
  \item B-tag SFs: the latest preliminary SF recommendations from the b-tagging group twiki \cite{btagSFMethods2016} are used to re-weight the FullSim MC samples. 
...
The latest recommendations for the treatment of signal systematics and
for the limit setting, as recently released
\cite{twiki-SUSYICHEP16}, have been adopted, except for the treatment
of ISR, for which we still use the same procedure used in 2015. We
will switch to the new procedure ASAP. 
