...
\subsection{Current issues and missing inputs\label{sec:disclaimers}}
Some key ingredients are still missing in the analysis, which are summarised below.
\begin{itemize}
...
high photon energy. The effect has been measured to be as large as 10\% at very high photon \pt, but is smaller for lower photon momenta. 
