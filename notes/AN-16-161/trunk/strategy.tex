...
\subsection{Updates with respect to AN-16-161\_v3 and outstanding issues with inputs\label{sec:disclaimers}}
...
\item \textbf{Data/MC correction factors}. The following data/MC scale factors (SF) have been used in this iteration of the analysis. 
  ...
  \item B-tag SFs: the latest recommendations from the b-tagging group twiki \cite{btagSFMethods2016} are used to re-weight the FullSim MC samples. 
    FastSim-to-FullSim scale factors are applied to the FastSim MC signal samples, following the latest recommendations. 
