...
luminosity of 6.3~$\ifb$ (the data/MC scale factors are also shown
in all plots).
...
respectively, which correspond to an integrated luminosity of 6.3
\ifb. 
...
determined from simulation, in the signal region for an integrated
luminosity of 6.3 \ifb. In addition to the total expected yield (SM)
