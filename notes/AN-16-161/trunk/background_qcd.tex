...
These data counts in the \mhtmet sideband are collected with the
...
of QCD multijet events, $\mathcal{Q}$, a maximum likelihood fit analagous to that
...
cut. After the contribution of the electroweak backgrounds is
subtracted, the
...
%TODO replace these plots (compile and rename them with a script)
\begin{figure}[!h]
  \centering
...
of QCD events, this approach is then validated by data-driven methods. 
...
%TODO replace plots and describe the validation method (including the
%fit)

%TODO fix this sentence and expand on it
