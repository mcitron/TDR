...
of QCD events, which are validated by data-driven methods. 
...
\begin{figure}[h!]
  \begin{center}
    ...
    \subfigure[{ Asymmetric, $\scalht<400$~GeV}]{\includegraphics[width=0.5\textwidth]{figures/qcd/validation/Ratio_Asym_HTlt400_nB}} \\
    \subfigure[{ Asymmetric, $\scalht>400$~GeV}]{\includegraphics[width=0.5\textwidth]{figures/qcd/validation/Ratio_Asym_HTgt400_mht}} ~~
...
\begin{figure}[h!]
  \begin{center}
    ...
    \subfigure[{ Symmetric, $\scalht<400$~GeV}]{\includegraphics[width=0.5\textwidth]{figures/qcd/validation/Ratio_Sym_HTlt400_nB}} \\
    \subfigure[{ Symmetric, $\scalht>400$~GeV}]{\includegraphics[width=0.5\textwidth]{figures/qcd/validation/Ratio_Sym_HTgt400_mht}} ~~
