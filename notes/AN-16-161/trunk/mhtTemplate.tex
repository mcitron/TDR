...
\begin{figure}[h!]
  \centering
  \subfigure[\gj, $\eq0$b, $\eq2$j category and \scalht 800-$\inf$\GeV bin]{
  ...
  \subfigure[\mj, $\eq1$b, $\eq4$a category and \scalht 350-400\GeV bin]{
  ...
  \subfigure[\mmj, $\eq0$b, $\eq4$j category and \scalht 400-500\GeV bin]{
  ...
  \subfigure[\gj, $\eq1$b, $\eq3$j category and \scalht 600-800\GeV bin]{
  ...
  \subfigure[\mj, $\eq2$b, $\eq4$j category and \scalht 600-800\GeV bin]{
  ...
  \subfigure[\mmj, $\eq0$b, $\eq3$a category and \scalht 300-350\GeV bin]{
