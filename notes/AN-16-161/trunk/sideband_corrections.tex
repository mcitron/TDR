...
The cross section for this process is known only at LO and no $k$-factor is available. 
...
Fig.~\ref{fig:pho-bias-sideband}. No evidence of bias in the sideband with respect to the control regions
is observed.
...
\begin{figure}[!h]
  ...
  This shows the sideband is approximately unbiased with respect to 
  these uncertainties for the sideband.}
...
to the yields in the control region for several sources of systematic uncertainty is shown in 
Fig.~\ref{fig:mu-bias-sideband} and Fig.~\ref{fig:mumu-bias-sideband}. This again shows no evidence
of bias in the sideband with respect to the control regions for these systematic sources.
...
The \wj and \ttbar prcosses are mainly constrained by the \mj sideband while the \zj and \gj processes are
