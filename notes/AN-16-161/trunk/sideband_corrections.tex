...
As the data collected in 2016 is still in an early stage of study the sideband corrections 
derived in 2015, as described in Sec.~\ref{app:sideband-corrections-old}, are used for results in this analysis. This will
be updated for the final result.
...
Fig.~\ref{fig:pho-bias-sideband}. The sideband is seen to be approximately unbiased compared to the 
signal region given the statistial power of the sample. Any residual bias is accounted for by including these systematics 
...
\begin{figure}[!h]
  ...
  No large biases (significantly higher than the statistical power of the sample) are observed.}
...
to the yields in the control region for several sources of systematic uncertainty is shown in 
Fig.~\ref{fig:mu-bias-sideband} and Fig.~\ref{fig:mumu-bias-sideband}. This again shows the
sideband is approximately unbiased with respect to the control regions for these systematic sources
compared to the statistical power of the sample. Any residual bias is accounted for by including these systematics 
in the fit when when deriving the sideband corrections.
