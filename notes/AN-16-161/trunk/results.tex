...
\begin{figure}[tbhp]
  ...
  \begin{center}
    ...
    \subfigure[Asymmetric categories CR only fit]{ \includegraphics[width=0.45\textwidth]{figures/postFitResults/nuisancePlotsMasked/AlphaT_asym_nuisances} } ~~
    \subfigure[Symmetric categories CR only fit]{ \includegraphics[width=0.45\textwidth]{figures/postFitResults/nuisancePlotsMasked/AlphaT_sym_nuisances} }
  \end{center}
\end{figure}
...
\begin{figure}[tbhp]
  ...
  \begin{center}
    ...
    \subfigure[Asymmetric categories CR only fit]{ \includegraphics[width=0.45\textwidth]{figures/postFitResults/nuisancePlotsMasked/gamma_Z_ratio_asym_nuisances} } ~~
    \subfigure[Symmetric categories CR only fit]{ \includegraphics[width=0.45\textwidth]{figures/postFitResults/nuisancePlotsMasked/gamma_Z_ratio_sym_nuisances} }
  \end{center}
\end{figure}
...
\begin{figure}[tbhp]
  ...
  \begin{center}
    ...
    \subfigure[Asymmetric categories CR only fit]{ \includegraphics[width=0.45\textwidth]{figures/postFitResults/nuisancePlotsMasked/W_Z_ratio_asym_nuisances} } ~~
    \subfigure[Symmetric categories CR only fit]{ \includegraphics[width=0.45\textwidth]{figures/postFitResults/nuisancePlotsMasked/W_Z_ratio_sym_nuisances} }
  \end{center}
\end{figure}
...
\begin{figure}[tbhp]
  ...
  \begin{center}
    ...
    \subfigure[Asymmetric categories CR only fit]{ \includegraphics[width=0.45\textwidth]{figures/postFitResults/nuisancePlotsMasked/tt_W_admixture_asym_nuisances} } ~~
    \subfigure[Symmetric categories CR only fit]{ \includegraphics[width=0.45\textwidth]{figures/postFitResults/nuisancePlotsMasked/tt_W_admixture_sym_nuisances} }
  \end{center}
\end{figure}
...
\begin{figure}[tbhp]
  ...
  \begin{center}
    ...
    \subfigure[Asymmetric categories CR only fit]{ \includegraphics[width=0.45\textwidth]{figures/postFitResults/nuisancePlotsMasked/WPol_asym_nuisances} } ~~
    \subfigure[Symmetric categories CR only fit]{ \includegraphics[width=0.45\textwidth]{figures/postFitResults/nuisancePlotsMasked/WPol_sym_nuisances} } 
  \end{center}
\end{figure}
...
\begin{figure}[tbhp]
  ...
  \begin{center}
    ...
    \subfigure[Asymmetric categories CR only fit]{ \includegraphics[width=0.45\textwidth]{figures/postFitResults/nuisancePlots/qcd_asym_nuisances} } ~~
    \subfigure[Symmetric categories CR only fit]{ \includegraphics[width=0.45\textwidth]{figures/postFitResults/nuisancePlotsMasked/qcd_sym_nuisances} }
  \end{center}
\end{figure}
...
\begin{figure}[tbhp]
  ...
  \begin{center}
    ...
    \subfigure[Full fit]{ \includegraphics[width=0.45\textwidth]{figures/postFitResults/nuisancePlots/Correlated_nuisances}}\\
    \subfigure[CR only fit]{ \includegraphics[width=0.45\textwidth]{figures/postFitResults/nuisancePlotsMasked/Correlated_nuisances}}\\
  \end{center}
\end{figure}
