...
corresponding to an integrated luminosity of 6.3 \ifb (\textbf{{\color{red} To be updated}}). 
...
In Fig.~\ref{fig:summaryPlot_Monojet}-~\ref{fig:summaryPlot_Symmetric} the background yield predictions (extracted from the CR-only fit) (\textbf{{\color{red} To be updated}}) 
...
The one-dimensional distributions of the pulls are shown in Fig.~\ref{fig:pulls1D} for the CR-only fit (\textbf{{\color{red} To be updated}}). 
...
for some (\njet,\nb,\scalht) analysis bins, for asymmetric and symmetric topologies (\textbf{{\color{red} To be updated}}).  \\
...
\clearpage
  \begin{center}
    \begin{figure}[h!]
      \caption{\textbf{{\color{red} To be updated}} Pulls of the observation compared to the prediction from the CR-only fit in the monojet categories (top-left), 
...
\clearpage
\begin{figure}[tbhp]
    \caption{ \textbf{{\color{red} To be updated}} \mht templates for some (\njet,\nb,\scalht) analysis bins, for the asymmetric topologies. \label{fig:mht-templates-asym} }
  \begin{center}
    \subfigure[$\njet = 4a$, $\nb = 0$, $350 < \scalht < 400$ GeV]{ \includegraphics[width=0.45\textwidth]{figures/postFitResults/shapePlots/mhtShape_eq0b_eq4a_350_400_prefit} } ~~
    \subfigure[$\njet = 3a$, $\nb = 0$, $400 < \scalht < 500$ GeV]{ \includegraphics[width=0.45\textwidth]{figures/postFitResults/shapePlots/mhtShape_eq0b_eq3a_400_500_prefit} } \\
    \subfigure[$\njet = 3a$, $\nb = 1$, $300 < \scalht < 350$ GeV]   { \includegraphics[width=0.45\textwidth]{figures/postFitResults/shapePlots/mhtShape_eq1b_eq3a_300_350_prefit} } ~~
    \subfigure[$\njet \geq 5a$, $\nb = 2$, $400 < \scalht < 500$ GeV]{ \includegraphics[width=0.45\textwidth]{figures/postFitResults/shapePlots/mhtShape_eq2b_ge5a_400_500_prefit} } \\
  \end{center}
\end{figure}
...
\begin{figure}[tbhp]
  ...
  \begin{center}
    \subfigure[$\njet = \geq 5$, $\nb = 0$, $500 < \scalht < 600$ GeV]{ \includegraphics[width=0.45\textwidth]{figures/postFitResults/shapePlots/mhtShape_eq0b_ge5j_500_600_prefit} } ~~
    \subfigure[$\njet = \geq 5$, $\nb = 2$, $500 < \scalht < 600$ GeV]{ \includegraphics[width=0.45\textwidth]{figures/postFitResults/shapePlots/mhtShape_eq2b_ge5j_500_600_prefit} } \\
    \subfigure[$\njet = \geq 5$, $\nb = 0$, $\scalht > 800$ GeV]   { \includegraphics[width=0.45\textwidth]{figures/postFitResults/shapePlots/mhtShape_eq0b_ge5j_800_Inf_prefit} } ~~
    \subfigure[$\njet = 2$, $\nb = 0$, $300 < \scalht < 350$ GeV]{ \includegraphics[width=0.45\textwidth]{figures/postFitResults/shapePlots/mhtShape_eq0b_eq2j_300_350_prefit} } \\
  \end{center}
\end{figure}
...
\begin{figure}[tbhp]
    \caption{ \textbf{{\color{red} To be updated}} Pull of the nuisances parameters associated to the $\ttbar+W$ template systematic uncertainty, 
      for the asymmetric (symmetric) categories on the left (right).
...
\begin{figure}[tbhp]
    \caption{ \textbf{{\color{red} To be updated}} Pull of the nuisances parameters associated to the $Z\rightarrow\nu\nu$ template systematic uncertainty, 
      for the asymmetric (symmetric) categories on the left (right).
