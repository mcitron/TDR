...
weakly interacting, massive neutralino and a Dark Matter (DM)
...
variable exploits azimuthal angular information and provides strong
rejection power against rare energetic events in which
%that yield multiple jets and 
neutrinos carry a significant fraction of a jet's energy due to
semileptonic decays of heavy-flavour mesons.
%, in which the neutrinos are typically collinear with respect to
%the axis of a jet and carry a significant fraction of the energy.
...
\caption{Representations of simplified models comprising the pair
  production of gluinos and their subsequent three-body decays to
  $qq\chiz$ (left) and $bb\chiz$ (right) via an off-shell
  light-flavour or bottom squark, respectively.}
\label{fig:feyn}
\end{figure*}
