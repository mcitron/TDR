...
%The \alphat definition can therefore be generalised as:
%
%\begin{equation}
%  \label{eq:alphat}
...
a size parameter of $0.4$. The jet energies %measured by the
%calorimeter systems 
...
energy above $40\gev$ and $|\eta| < 3$. % thresholds summarised in
