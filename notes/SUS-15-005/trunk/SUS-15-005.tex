...
%%%%%%%%%%%%%%%  Title page %%%%%%%%%%%%%%%%%%%%%%%%
\cmsNoteHeader{SUS-15-005} % This is over-written in the CMS environment: useful as preprint no. for export versions
% >> Title: please make sure that the non-TeX equivalent is in PDFTitle below
\title{Search for new physics in final states with jets and missing transverse momentum in sqrt(s) = 13 TeV pp collisions with the alpha_T variable}
...
pdftitle={Search for new physics in final states with jets and missing transverse momentum in sqrt(s) = 13 TeV pp collisions with the alpha_T variable},%
pdfsubject={CMS},%
