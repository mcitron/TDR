...
\begin{figure}[!h]
  \begin{center}
    ...
    \caption{(Top panel) Event yields observed in data (solid circles)
      ...
      (blue circles). {\color{red} These are the full fit plots, to be
      replaced with the CR-only fits.} }
    \label{fig:mono}
  \end{center}
\end{figure}
...
\begin{figure*}[!h]
  \begin{center}
    ...
    \caption{(Top panel) Event yields observed in data (solid circles)
      ...
      and full fit (blue circles). {\color{red} These are the full fit plots, to be
      replaced with the CR-only fits.} }
    \label{fig:asym}
  \end{center}
\end{figure*}
