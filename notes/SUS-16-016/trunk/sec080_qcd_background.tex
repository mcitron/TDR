...
%The non-multijet background estimation in the \mhtmet sideband is
%assigned a 20\% systematic, based on typical values for the
%uncertainties on these backgrounds, discussed in
%Sec.~\ref{sec:ewk_background}.


%% Finally, data control variables are inspected to provide
