...
\begin{figure*}[thp!]
  \begin{center}
    ...
    \caption{Observed upper limit in cross section at 95\% confidence
      ...
      assume the gluino-mediated (Top Left) and direct (Top Right)
      production of bottom-squark pairs, and the direct production of
      top-squark pairs (Bottom), as a function of the gluino or squark
      mass and the $\chiz_{1}$ mass. The black solid thick (thin)
      line indicates the observed mass exclusion regions assuming the
      nominal (${\pm}1 \sigma$ theory uncertainty) production cross
      section. The red dashed thick (thin) line indicates the median
      (${\pm}1 \sigma$ experimental uncertainty) expected mass
      exclusion regions. }
...
gluino-mediated and direct production of bottom-squark pairs, and the
direct production of top-squark pairs. Also shown are the observed
...
with the ${\pm}1$ standard-deviation variations. This search places
stringent limits in the mass parameter space of these models, with
observed exclusions in gluino and \chiz masses as high as,
respectively, 1750 and 1200\GeV. Similarly, in the case of direct
squark production, bottom squark and \chiz masses as high as 1000 and
525\GeV are excluded. Finally, top squark and \chiz masses up to 850
and 350\GeV are excluded.
