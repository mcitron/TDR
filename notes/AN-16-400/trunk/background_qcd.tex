...
%%%%%%%%%%%%%%%%%%% STUFF ABOUT TRIGGER EFFICIENCES? (muons + photons)

The sidebands are enriched in QCD multijet events, but the contribution
...
\begin{figure}[!t]
  ...
  \subfigure[Data counts.]{
    \includegraphics[width=0.5\textwidth]{figures/qcd/newMethod/mhtDivMet/obsYields_QcdSb}
  } 
  \subfigure[Post-fit EWK background estimates.]{
    \includegraphics[width=0.5\textwidth]{figures/qcd/newMethod/mhtDivMet/postFitEwkYields_QcdSb}
  } \\
  \subfigure[Post-fit constraints on $\mu_{\textrm{QCD}}$.]{
    \includegraphics[width=0.5\textwidth]{figures/qcd/newMethod/mhtDivMet/rateParsQcd_QcdSb}
  } 
  \subfigure[Post-fit QCD background estimates.]{
    \includegraphics[width=0.5\textwidth]{figures/qcd/newMethod/mhtDivMet/postFitQcdYields_QcdSb}
  } \\
...
\begin{figure}[!t]
  \centering
  \subfigure[Data counts.]{
    \includegraphics[width=0.5\textwidth]{figures/qcd/newMethod/bDPhi/obsYields_QcdSb}
  } 
  \subfigure[Post-fit EWK background estimates.]{
    \includegraphics[width=0.5\textwidth]{figures/qcd/newMethod/bDPhi/postFitEwkYields_QcdSb}
  } \\
  \subfigure[Post-fit constraints on $\mu_{\textrm{QCD}}$.]{
    \includegraphics[width=0.5\textwidth]{figures/qcd/newMethod/bDPhi/rateParsQcd_QcdSb}
  } 
  \subfigure[Post-fit QCD background estimates.]{
    \includegraphics[width=0.5\textwidth]{figures/qcd/newMethod/bDPhi/postFitQcdYields_QcdSb}
  } \\
  \caption{Data counts, post-fit estimates of the EWK and QCD
    background contributions, and the constrained values of the
    floating parameters $\mu_{\textrm{QCD}}$, in (\njet, \scalht) bins
...
\begin{figure}[!t]
  \centering
  \subfigure[Data counts.]{
    \includegraphics[width=0.5\textwidth]{figures/qcd/newMethod/double/obsYields_QcdSb}
  } 
  \subfigure[Post-fit EWK background estimates.]{
    \includegraphics[width=0.5\textwidth]{figures/qcd/newMethod/double/postFitEwkYields_QcdSb}
  } \\
  \subfigure[Post-fit constraints on $\mu_{\textrm{QCD}}$.]{
    \includegraphics[width=0.5\textwidth]{figures/qcd/newMethod/double/rateParsQcd_QcdSb}
  } 
  \subfigure[Post-fit QCD background estimates.]{
    \includegraphics[width=0.5\textwidth]{figures/qcd/newMethod/double/postFitQcdYields_QcdSb}
  } \\
  \caption{Data counts, post-fit estimates of the EWK and QCD
    background contributions, and the constrained values of the
    floating parameters $\mu_{\textrm{QCD}}$, in (\njet, \scalht) bins
...
\begin{figure}[!t]
  ...
  % } \\
  % \subfigure[QCD background estimates.]{
  %   \includegraphics[width=0.5\textwidth]{figures/qcd/newMethod/meanPredictedQcd_Signal}
  % } 
...
\begin{figure}[!t]
  \centering
  \subfigure[Difference between \mhtmet and \bdphi sidebands]{
    \includegraphics[width=0.5\textwidth]{figures/qcd/newMethod/validation/rateParRatioMhtMetDivBDPhi1d}
  } 
  \subfigure[Difference between \bdphi and double sidebands]{
    \includegraphics[width=0.5\textwidth]{figures/qcd/newMethod/validation/rateParRatioBDPhiDivDoubleSb1d}
  } \\
  \caption{The percentage difference in the scaling factors of the QCD
  simulation, $\mu_{\textrm{QCD}}$, calculated for each of the sidebands.}
  \label{fig:qcdVal}
\end{figure}

% This ratio is validated
