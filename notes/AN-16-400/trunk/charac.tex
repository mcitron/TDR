...
%\input{tables/yieldSM/signal.tex}
%\clearpage
%\input{tables/yieldSM/singlemu.tex}
%\clearpage
%\input{tables/yieldSM/doublemu.tex}
%\clearpage
%\input{tables/yieldSM/singlephoton.tex}
...
\begin{figure}[!h]
    \begin{center}
        ...
        \subfigure {\includegraphics[width=0.5\textwidth]{figures/distributions/SingleMu/nBJet40_asym_all.pdf}} \\
...
\begin{figure}[!h]
    \begin{center}        
        ...
        \subfigure {\includegraphics[width=0.5\textwidth]{figures/distributions/SingleMu/jet_phi[0]_mono_all.pdf}} \\
...
\begin{figure}[!h]
    \begin{center}
        ...
        \subfigure {\includegraphics[width=0.5\textwidth]{figures/distributions/DoubleMu/nBJet40_asym_all.pdf}} \\
...
\begin{figure}[!h]
    \begin{center} 
        ...
        \subfigure {\includegraphics[width=0.5\textwidth]{figures/distributions/DoubleMu/jet_phi[0]_mono_all.pdf}} \\
